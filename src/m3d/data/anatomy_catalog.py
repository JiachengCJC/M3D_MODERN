...
_TERM_DESCRIPTIONS_RAW = {'liver': ('Primary organ responsible for detoxifying the blood by removing harmful substances.',
           ...
           'Regenerates and repairs damaged tissue.',
           'Common site for conditions such as hepatitis and cirrhosis.'),
 'carotid artery left': ('Major blood vessel that supplies oxygenated blood to the left side of '
                         'the head and neck.',
                         'Arises from the aorta and travels along the left side of the neck.',
                         'A left artery, critical for providing oxygen and nutrients to the brain '
                         'and facial structures.',
                         'A left artery, palpable pulse point used for assessing cardiovascular '
                         'health.',
 ...
 'carotid artery right': ('Major blood vessel that supplies oxygenated blood to the right side of '
                          'the head and neck.',
                          'Arises from the brachiocephalic trunk and ascends along the right side '
                          'of the neck.',
                          "Artery transporting oxygenated blood to the brain's right hemisphere.",
                          "Major blood vessel located in the neck, supplying the brain's right "
                          'side.',
                          ...
                          'Primary arterial route supplying the right cerebral hemisphere with '
                          'oxygenated blood.'),
 'arytenoid': ('Small cartilage in the larynx responsible for vocal cord movement.',
 ...
 'bone mandible': ('Horseshoe-shaped bone forming the lower jaw.',
 ...
 'brainstem': ('Connects the brain to the spinal cord and facilitates communication between the '
               'two.',
               ...
               'Lower part of the brain responsible for involuntary actions like breathing and '
               'heartbeat.',
               'Anatomical region regulating essential functions such as consciousness and sleep.'),
 'buccal mucosa': ('Inner lining of the cheeks and other areas within the oral cavity.',
                   'Mucous membrane that covers the inner surfaces of the oral cavity.',
                   'Protects underlying tissues and aids in food propulsion during chewing and '
                   'swallowing.',
 ...
 'oral cavity': ('Cavity within the mouth comprising the lips, cheeks, gums, and tongue.',
                 'Functions as the entry point for food and serves as the initial site of '
                 'digestion.',
 ...
 'cochlea left': ('Spiral-shaped organ in the inner ear responsible for hearing on the left side.',
                  ...
                  "Organ responsible for detecting and transmitting sound waves to the brain's "
                  'left hemisphere.',
                  'Left cochlear structure within the temporal bone, facilitating hearing.'),
 'cochlea right': ('Spiral-shaped sensory organ for hearing, situated on the right side.',
                   ...
                   'Spiral-shaped organ in the inner ear responsible for hearing on the right '
                   'side.',
                   'Right-sided auditory structure converting sound vibrations into neural '
                   'signals.',
 ...
 'cricopharyngeal inlet': ('Opening at the top of the esophagus leading to the larynx.',
                           ...
                           'Junction between the pharynx and the upper part of the swallowing '
                           'tube.',
                           'Anatomical site marking the transition from the throat to the '
                           'esophagus.'),
 'cervical esophagus': ('Part of the digestive tract connecting the pharynx to the stomach.',
                        'Located in the neck and chest, posterior to the trachea.',
                        'Facilitates the transport of food and liquids from the mouth to the '
                        'stomach.',
                        'Composed of smooth muscle tissue undergoing peristalsis for efficient '
                        'food movement.',
                        'Subject to various disorders, including gastroesophageal reflux disease '
                        '(GERD).',
 ...
 'anterior eyeball left': ('Front part of the eye located on the left side.',
                           ...
                           'Anterior structure of the left eye involved in light refraction and '
                           'pupil dilation.',
                           ...
                           'Area of the left eye responsible for initial light reception and '
                           'focus.',
                           'Anterior structure of the left eye involved in vision and light '
                           'detection.'),
 'anterior eyeball right': ('Front part of the eye situated on the right side.',
                            'Anterior segment of the right eyeball within the eye socket.',
                            'Forward-facing portion of the right eye, including the cornea and '
                            'iris.',
                            'Area of the right eye responsible for initial light reception and '
                            'focus.',
                            'Anterior structure of the right eye involved in vision and light '
                            'detection.',
                            ...
                            'Anterior structure of the right eye involved in vision and light '
                            'detection.'),
 'posterior eyeball left': ('Back part of the eye situated on the left side.',
                            'Rear segment of the left eyeball within the eye socket.',
                            'Portion of the left eye facing away from the front.',
                            'Area of the left eye involved in image processing and signal '
                            'transmission.',
                            'Posterior structure of the left eye responsible for visual '
                            'perception.'),
 'posterior eyeball right': ('Back part of the eye situated on the right side.',
                             'Rear segment of the right eyeball within the eye socket.',
                             'Portion of the right eye facing away from the front.',
                             'Area of the right eye involved in image processing and signal '
                             'transmission.',
                             'Posterior structure of the right eye responsible for visual '
                             'perception.'),
 'lacrimal gland left': ('Gland responsible for tear production located on the left side.',
                         ...
                         'Glandular tissue in the left eye involved in tear formation and '
                         'distribution.'),
 'lacrimal gland right': ('Gland responsible for tear production located on the right side.',
                          ...
                          'Glandular tissue in the right eye involved in tear formation and '
                          'distribution.'),
 'submandibular gland left': ('Gland located on the left side beneath the lower jaw.',
                              ...
                              'Glandular tissue beneath the left side of the jaw involved in '
                              'saliva secretion.',
                              'Left submandibular gland aiding in oral lubrication and enzyme '
                              'production.'),
 'submandibular gland right': ('Gland located on the right side beneath the lower jaw.',
                               'Right-sided salivary organ positioned beneath the mandible.',
                               'Submandibular structure on the right producing saliva for '
                               'digestion.',
                               'Glandular tissue beneath the right side of the jaw involved in '
                               'saliva secretion.',
                               'Right submandibular gland aiding in oral lubrication and enzyme '
                               'production.',
                               'Salivary gland situated under the jawline on the right side.',
                               'Organ beneath the right mandible responsible for saliva '
                               'production.',
                               'Glandular structure on the right side assisting in swallowing and '
                               'digestion.',
                               'Right-sided gland contributing to the lubrication of the oral '
                               'cavity.',
                               'Submandibular organ on the right side aiding in the digestive '
                               'process.'),
 'thyroid': ('Endocrine gland located in the neck, responsible for hormone production.',
 ...
 'larynx glottis': ('Part of the larynx involved in the production of sound and phonation.',
 ...
 'larynx supraglottic': ('Upper portion of the larynx above the glottis.',
 ...
 'lips': ('External body part forming the boundary of the mouth.',
 ...
 'optic chiasm': ('Point of crossing of the optic nerves located at the base of the brain.',
                  ...
                  'Location where visual information from both eyes combines and partially crosses '
                  'over.',
 ...
 'optic nerve left': ('Nerve responsible for transmitting visual information from the left eye to '
                      'the brain.',
                      ...
                      'Optic pathway originating from the left eye and transmitting visual '
                      'stimuli.',
 ...
 'optic nerve right': ('Nerve responsible for transmitting visual information from the right eye '
                       'to the brain.',
                       ...
                       'Optic pathway originating from the right eye and transmitting visual '
                       'stimuli.',
                       'Neural connection transmitting visual information solely from the right '
                       'eye.',
 ...
 'parotid gland left': ('Salivary gland located in front of the ear on the left side.',
 ...
 'parotid gland right': ('Salivary gland located in front of the ear on the right side.',
 ...
 'pituitary gland': ('Endocrine gland located at the base of the brain.',
                     'Secretes hormones that regulate growth, metabolism, and other endocrine '
                     'functions.',
                     ...
                     'Glandular organ involved in the control of growth, metabolism, and '
                     'reproduction.',
 ...
 'spinal cord': ('Long, tubular structure extending from the base of the brain down the vertebral '
                 'column.',
