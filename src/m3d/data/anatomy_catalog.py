"""Immutable anatomical class catalogue reproduced from the original M3D repo.

The original training datasets rely on two large Python dictionaries:

``dataset_info``
    Maps each Decathlon-style dataset tag (``0000`` ... ``0025``) to the
    ordered class-name list used by the integer encoded in a label filename.

``term_dict``
    Maps every class name to natural-language descriptions used by the
    description variants of REC, REG, and segmentation prompts.

This file preserves the original ordering, duplicate class entries, spelling,
and description text.  The public compatibility aliases ``dataset_info`` and
``term_dict`` are read-only mappings whose values are tuples, preventing a
DataLoader worker from mutating prompt semantics during training.
"""
...
class AnatomyCatalogError(RuntimeError):
    """Raised when a dataset tag, class ID, or description is invalid."""


_DATASET_CLASS_NAMES_RAW = {'0000': ('liver',),
 '0001': ('myocardium of LV (Myo)',
          'left atrium (LA)',
          'left ventricle (LV)',
          'right atrium (RA)',
          'right ventricle (RV)',
          ...
          'right posterolateral branch (RPLB)',
          'ramus intermedius (RAMUS)',
          'left posterolateral branch (LPLB)'),
 '0002': ('spleen',
          'right kidney',
          'left kidney',
          'gall bladder',
...
_TERM_DESCRIPTIONS_RAW = {'liver': ('Primary organ responsible for detoxifying the blood by removing harmful substances.',
           ...
           'Regenerates and repairs damaged tissue.',
           'Common site for conditions such as hepatitis and cirrhosis.'),
 'myocardium of LV (Myo)': ('Muscular wall of the left ventricle responsible for pumping oxygenated blood to the body.',
                     'The thickest myocardial layer, generating the high pressure needed for systemic circulation.',
                     'Left ventricular muscle tissue critical for cardiac output and systemic perfusion.',
                     'Cardiac muscle forming the wall of the left ventricle, essential for ejection of blood.',
                     'Myocardial tissue of the left ventricle, key determinant of cardiac function.',
                     'Thick muscular wall surrounding the left ventricular cavity.',
                     'Contractile tissue of the left ventricle driving oxygenated blood into the aorta.',
                     'Primary pumping muscle of the heart on the left side.'),
 'left atrium (LA)': ('Upper-left chamber of the heart that receives oxygenated blood from the pulmonary veins.',
                 'Thin-walled cardiac chamber that passes blood through the mitral valve to the left ventricle.',
                 'Posterior chamber of the heart receiving pulmonary venous return.',
                 'Left atrial chamber, conduit between pulmonary circulation and left ventricle.',
                 'Receiving chamber for oxygenated blood returning from the lungs.',
                 'Upper-left heart compartment preceding the left ventricle.',
                 'Cardiac chamber that collects blood from all four pulmonary veins.',
                 'Low-pressure chamber that stores and forwards oxygenated blood to the left ventricle.'),
 'left ventricle (LV)': ('Main pumping chamber of the heart that ejects oxygenated blood into the aorta.',
                    'Thick-walled lower-left cardiac chamber responsible for systemic circulation.',
                    'Largest and most muscular heart chamber, generating systemic arterial pressure.',
                    'Left ventricular cavity containing blood ejected to the body through the aortic valve.',
                    'High-pressure cardiac chamber driving blood through the systemic vasculature.',
                    'Primary pump of the cardiovascular system located on the left side of the heart.',
                    'Conical chamber below the left atrium that performs the majority of cardiac work.',
                    'Chamber whose ejection fraction reflects overall left heart function.'),
 'right atrium (RA)': ('Upper-right chamber of the heart that receives deoxygenated blood from the venae cavae.',
                  'Thin-walled chamber that passes systemic venous blood through the tricuspid valve.',
                  'Receiving chamber for the superior and inferior vena cava.',
                  'Right atrial compartment serving as entry point for deoxygenated systemic blood.',
                  'Low-pressure receiving chamber on the right side of the heart.',
                  'Cardiac chamber collecting venous return before it enters the right ventricle.',
                  'Upper-right heart compartment that also houses the sinoatrial node.',
                  'Right-sided atrium forwarding blood to the right ventricle for pulmonary circulation.'),
 'right ventricle (RV)': ('Lower-right chamber of the heart that pumps deoxygenated blood to the lungs via the pulmonary artery.',
                     'Thin-walled cardiac chamber driving blood through the pulmonary circulation.',
                     'Right ventricular cavity beneath the right atrium, operating at lower pressures than the left ventricle.',
                     'Crescent-shaped chamber that generates the pressure needed for pulmonary blood flow.',
                     'Pump of the pulmonary circuit, ejecting blood to the pulmonary artery.',
                     'Right-sided ventricle responsible for delivering blood to the lungs for oxygenation.',
                     'Lower-right cardiac chamber whose dysfunction can cause pulmonary hypertension.',
                     'Inferior right heart compartment, essential for the pulmonary circuit.'),
 'ascending aorta (AO)': ('First segment of the aorta, rising from the left ventricle toward the aortic arch.',
                     'Carries oxygenated blood from the heart toward the head and systemic circulation.',
                     'Proximal aortic segment arising from the aortic root above the aortic valve.',
                     'Tubular vessel connecting the left ventricle to the aortic arch.',
                     'Initial portion of the aorta, site of the coronary artery ostia.',
                     'Ascending portion of the aorta before the arch, typically 5-6 cm in length.',
                     'Critical conduit for cardiac output from the left ventricle to the systemic circulation.',
                     'First segment of the thoracic aorta, bounded by the aortic root and the aortic arch.'),
 'pulmonary artery': ('Large vessel carrying deoxygenated blood from the right ventricle to the lungs.',
                      'Main pulmonary trunk that bifurcates into left and right pulmonary arteries.',
                      'Sole artery in the body that carries deoxygenated blood under normal conditions.',
                      'Vessel conducting venous blood from the right heart to the pulmonary vasculature.',
                      'Pulmonary arterial trunk originating from the right ventricular outflow tract.',
                      'Central vessel linking the right ventricle to the pulmonary circulation.',
                      'Large low-pressure artery supplying the lungs with blood for gas exchange.',
                      'Main conduit of the pulmonary circuit emerging from the pulmonic valve.'),
 'pulmonary artery (PA)': ('Large vessel carrying deoxygenated blood from the right ventricle to the lungs.',
                      'Main pulmonary trunk that bifurcates into left and right pulmonary arteries.',
                      'Sole artery in the body that carries deoxygenated blood under normal conditions.',
                      'Vessel conducting venous blood from the right heart to the pulmonary vasculature.',
                      'Pulmonary arterial trunk originating from the right ventricular outflow tract.',
                      ...
                      'Large low-pressure artery supplying the lungs with blood for gas exchange.',
                      'Main conduit of the pulmonary circuit emerging from the pulmonic valve.'),
 'descending aorta (DO)': ('Segment of the aorta that descends through the thorax and abdomen, supplying the body below the arch.',
                      'Thoracic and abdominal portion of the aorta delivering oxygenated blood to trunk and lower limbs.',
                      'Portion of the aorta distal to the aortic arch, running along the vertebral column.',
                      'Descending thoracic aorta transitioning into the abdominal aorta at the diaphragm.',
                      'Major vessel carrying oxygenated blood to the lower body and thoracic organs.',
                      'Long arterial segment extending from the aortic arch to the aortic bifurcation.',
                      'Posterior mediastinal structure supplying intercostal and visceral branches.',
                      'Aortic segment distal to the arch, a critical conduit for systemic blood distribution.'),
 'right coronary artery (RCA)': ('Coronary artery arising from the right aortic sinus supplying the right ventricle and inferior heart.',
                           'Vessel coursing in the right atrioventricular groove to supply the right-sided cardiac structures.',
                           'RCA, dominant in most patients, supplying the SA and AV nodes.',
                           'Right-sided coronary vessel supplying the posterior descending artery in most individuals.',
                           'Coronary artery responsible for perfusing the inferior wall of the left ventricle in right-dominant hearts.',
                           'Artery originating at the right coronary ostium supplying right atrium, right ventricle, and inferior LV.',
                           'Main coronary vessel of the right side of the heart.',
                           'Right coronary artery branching into the PDA and posterolateral branches in right-dominant anatomy.'),
 'right posterior descending artery (RPDA)': ('Branch of the right coronary artery supplying the inferior interventricular septum.',
                                       'RPDA, the posterior descending artery in right-dominant coronary anatomy.',
                                       'Terminal branch of the RCA coursing in the posterior interventricular groove.',
                                       'Vessel perfusing the posterior third of the interventricular septum and inferior LV wall.',
                                       'Key RCA branch responsible for inferior septal perfusion.',
                                       'Posterior descending artery arising from the right coronary artery.',
                                       'Coronary branch supplying the inferior wall and posterior septum.',
                                       'Right-dominant posterior descending branch of the coronary circulation.'),
 'left anterior descending artery (LAD)': ('Coronary artery arising from the left main and coursing in the anterior interventricular groove.',
                                     'LAD, the largest branch of the left coronary artery supplying the anterior LV wall and septum.',
                                     'Most critical coronary artery, often called the widow-maker for its role in anterior MI.',
                                     'Vessel perfusing the anterior two-thirds of the interventricular septum.',
                                     'Anterior descending branch supplying the apex and anterior left ventricular wall.',
                                     'Left anterior descending coronary artery giving rise to diagonal and septal branches.',
                                     'Major coronary vessel responsible for anterior myocardial perfusion.',
                                     'LAD coursing along the anterior surface of the heart to supply the apex.'),
 'first diagonal branch (D1)': ('First major diagonal branch of the left anterior descending artery.',
                            'D1, a lateral branch of the LAD supplying the anterolateral left ventricular wall.',
                            'First diagonal coronary branch arising from the LAD.',
                            'Lateral branch perfusing the anterolateral myocardium of the left ventricle.',
                            'Initial diagonal offshoot of the left anterior descending artery.',
                            'Branch of the LAD directed toward the lateral wall of the left ventricle.',
                            'First diagonal artery, a major LAD side branch.',
                            'D1 branch contributing to anterolateral wall perfusion.'),
 'second diagonal branch (D2)': ('Second major diagonal branch of the left anterior descending artery.',
                             'D2, a lateral branch of the LAD supplying the mid-anterolateral left ventricular wall.',
                             'Distal diagonal branch of the LAD after the first diagonal.',
                             'Secondary lateral branch arising from the left anterior descending artery.',
                             'Second diagonal artery contributing to lateral myocardial perfusion.',
                             'Coronary branch extending from the LAD toward the lateral left ventricle.',
                             'D2 branch of the left anterior descending coronary artery.',
                             'Second lateral offshoot of the LAD perfusing the anterolateral myocardium.'),
 'left circumflex artery (LCX)': ('Major branch of the left main coronary artery coursing in the left atrioventricular groove.',
                             'LCX, supplying the lateral and posterior walls of the left ventricle.',
                             'Circumflex coronary artery wrapping around the left side of the heart.',
                             'Vessel responsible for lateral wall perfusion of the left ventricle.',
                             'Left circumflex, dominant in left-dominant coronary anatomy.',
                             'Coronary artery giving rise to obtuse marginal branches along the lateral wall.',
                             'Branch of the left main coronary system perfusing posterior and lateral LV.',
                             'LCX running in the posterior AV groove to supply lateral cardiac structures.'),
 'first obtuse marginal branch (OM1)': ('First lateral branch of the left circumflex artery supplying the lateral left ventricular wall.',
                                   'OM1, the principal obtuse marginal branch of the LCX.',
                                   'First obtuse marginal artery arising from the left circumflex.',
                                   'Lateral wall coronary branch off the left circumflex artery.',
                                   'Initial obtuse marginal branch perfusing the lateral myocardium.',
                                   'OM1, major side branch of the circumflex supplying lateral LV.',
                                   'First lateral-wall branch of the left circumflex coronary artery.',
                                   'Obtuse marginal branch 1 contributing to lateral wall blood supply.'),
 'second obtuse marginal branch (OM2)': ('Second lateral branch of the left circumflex artery supplying the lateral left ventricular wall.',
                                    'OM2, the secondary obtuse marginal branch of the LCX.',
                                    'Second obtuse marginal artery arising distally along the left circumflex.',
                                    'Distal lateral branch of the left circumflex coronary artery.',
                                    'OM2, contributing to posterolateral myocardial perfusion.',
                                    'Second obtuse marginal branch of the circumflex supplying lateral LV wall.',
                                    'Secondary lateral-wall branch of the left circumflex artery.',
                                    'Obtuse marginal branch 2 of the LCX perfusing mid-to-distal lateral myocardium.'),
 'left posterior descending artery (LPDA)': ('Posterior descending artery arising from the left circumflex in left-dominant coronary anatomy.',
                                       'LPDA, the PDA in left-dominant systems, supplying the inferior interventricular septum.',
                                       'Terminal branch of the left circumflex coursing in the posterior interventricular groove.',
                                       'Vessel perfusing the posterior septum in left-dominant hearts.',
                                       'Left-dominant posterior descending branch of the coronary circulation.',
                                       'Posterior descending artery originating from the LCX instead of the RCA.',
                                       'LPDA supplying the inferior wall and posterior septum in left-dominant anatomy.',
                                       'Circumflex-derived posterior descending coronary branch.'),
 'right posterolateral branch (RPLB)': ('Posterolateral branch of the right coronary artery supplying the posterior left ventricular wall.',
                                  'RPLB, a terminal RCA branch in right-dominant coronary anatomy.',
                                  'Right posterolateral coronary branch perfusing the inferolateral myocardium.',
                                  'Branch of the RCA supplying the posterior and lateral left ventricular wall.',
                                  'Right-sided posterolateral artery arising from the RCA distal to the PDA.',
                                  'Terminal branch of the right coronary artery in right-dominant hearts.',
                                  'RPLB contributing to posterior and lateral wall perfusion.',
                                  'Posterolateral branch of the RCA, supplying inferoposterior LV segments.'),
 'ramus intermedius (RAMUS)': ('Intermediate branch arising between the left anterior descending and left circumflex arteries.',
                       'RAMUS, a trifurcation variant of the left main coronary artery.',
                       'Ramus intermedius, present when the left main bifurcates into three branches.',
                       'Intermediate coronary branch supplying the lateral wall when present.',
                       'Third branch of the left coronary system between the LAD and LCX.',
                       'Ramus intermedius supplying the anterolateral or lateral myocardium.',
                       'Intermediate artery arising at the left main bifurcation, a normal anatomical variant.',
                       'Coronary branch between the LAD and circumflex, supplying the lateral LV wall.'),
 'left posterolateral branch (LPLB)': ('Posterolateral branch of the left circumflex artery in left-dominant coronary anatomy.',
                                 'LPLB, a terminal LCX branch supplying the posterior and lateral left ventricular wall.',
                                 'Left posterolateral coronary branch arising from the circumflex in left-dominant hearts.',
                                 'Branch of the LCX perfusing the posterolateral myocardium.',
                                 'Left-sided posterolateral artery supplying the inferior and lateral LV segments.',
                                 'Terminal branch of the left circumflex in left-dominant coronary circulation.',
                                 'LPLB contributing to posterolateral myocardial perfusion.',
                                 'Posterolateral branch of the LCX in left-dominant coronary anatomy.'),
 'spleen': ('Organ located in the upper left abdomen, part of the lymphatic system.',
            ...
            'Connected to vessels such as the splenic vein and splenic artery, participating in '
            'blood circulation.',
            'Filled with blood, it filters and cleanses the blood by removing aging red blood '
            'cells.',
            'Plays a significant role in the immune system, providing defense and immune '
            'functions.',
            'Positioned in a relatively fixed location in the abdominal cavity, adjacent to the '
            'stomach and kidneys.',
            ...
            'Produces white blood cells and antibodies.',
            'Subject to conditions such as splenomegaly and traumatic injury.'),
 'right kidney': ('One of a pair of bean-shaped organs located on the right side of the abdomen.',
                  'Right kidney is one of a pair of bean-shaped organs located on the right side '
                  'of the abdomen.',
                  'One of a pair of bean-shaped organs located on the right and left sides of the '
                  'abdomen.',
 ...
 'left kidney': ('One of a pair of bean-shaped organs located on the left side of the abdomen.',
                 'Left kidney is one of a pair of bean-shaped organs located on the left side of '
                 'the abdomen.',
                 'One of a pair of bean-shaped organs located on the left and right sides of the '
                 'abdomen.',
 ...
 'gall bladder': ('Organ responsible for storing and concentrating bile.',
 ...
 'esophagus': ('Muscular tube connecting the throat to the stomach.',
 ...
 'stomach': ('Muscular organ located in the upper abdomen, part of the digestive system.',
             ...
             'Comprising different parts such as the fundus, body, and antrum, it secretes gastric '
             'juices.',
             'Involved in the storage, mixing, and initial digestion of food during the digestive '
             'process.',
             'Connected to the esophagus and small intestine, working in coordination to complete '
             'the digestion process.',
             'Generates a feeling of fullness during the eating process, signaling satiety to the '
             'brain.',
 ...
 'aorta': ('Main artery of the body, originating from the left ventricle of the heart.',
           ...
           'Large blood vessel that carries oxygenated blood from the heart to the rest of the '
           'body.',
 ...
 'postcava': ('Large vein returning deoxygenated blood from the lower body to the heart.',
              ...
              'Large blood vessel delivering deoxygenated blood to the heart from the abdomen and '
              'lower body.',
              'Principal vein returning blood to the heart from the lower regions of the body.'),
 'pancreas': ('Glandular organ located behind the stomach in the abdomen.',
              ...
              'Organ with exocrine and endocrine functions aiding in digestion and blood sugar '
              'regulation.',
              ...
              'Dual-purpose gland producing enzymes for digestion and hormones for blood sugar '
              'control.',
              'Glandular organ involved in digestion and glucose metabolism.'),
 'right adrenal gland': ('Endocrine gland located on the right kidney producing hormones like '
                         'cortisol and adrenaline.',
                         'Glandular organ positioned on the right kidney involved in hormone '
                         'secretion.',
                         'Adrenal structure situated on the right side of the body, regulating '
                         'stress response.',
                         'Organ on the right kidney releasing hormones for stress and metabolism.',
                         'Glandular tissue adjacent to the right kidney producing adrenal '
                         'hormones.',
                         'Endocrine organ located on the right side of the body, regulating '
                         'metabolism and stress.',
                         'Adrenal gland on the right side of the body secreting hormones like '
                         'cortisol.',
                         "Right-sided glandular structure involved in the body's fight-or-flight "
                         'response.',
                         'Gland situated on the right kidney producing hormones to regulate '
                         'metabolism.',
                         'Organ on the right side of the body releasing hormones for stress '
                         'management.'),
 'left adrenal gland': ('Endocrine gland located on the left kidney producing hormones like '
                        'cortisol and adrenaline.',
                        'Glandular organ positioned on the left kidney involved in hormone '
                        'secretion.',
                        'Adrenal structure situated on the left side of the body, regulating '
                        'stress response.',
                        ...
                        'Endocrine organ located on the left side of the body, regulating '
                        'metabolism and stress.',
                        'Adrenal gland on the left side of the body secreting hormones like '
                        'cortisol.',
                        "Left-sided glandular structure involved in the body's fight-or-flight "
                        'response.',
                        'Gland situated on the left kidney producing hormones to regulate '
                        'metabolism.',
                        'Organ on the left side of the body releasing hormones for stress '
                        'management.'),
 'duodenum': ('First part of the small intestine, connected to the stomach.',
              ...
              'Initial segment of the small intestine receiving digestive juices from the pancreas '
              'and liver.',
 ...
 'bladder': ('Organ in the lower abdomen storing urine before excretion.',
 ...
 'prostate or uterus': ('Reproductive organ in males responsible for producing seminal fluid.',
 ...
 'kidney tumor': ('Abnormal growth of cells in the kidney.',
 ...
 'renal vein': ('Vein that carries blood away from the kidney.',
 ...
 'renal artery': ('Blood vessel supplying the kidney with oxygenated blood.',
 ...
 'tumor': ('Abnormal mass of tissue resulting from uncontrolled cell growth.',
 ...
 'gallbladder': ('Organ storing bile produced by the liver.',
 ...
 'inferior vena cava': ('Large vein carrying deoxygenated blood from the lower body to the heart.',
                        'Major blood vessel returning blood from the lower half of the body to the '
                        'heart.',
                        'Vein responsible for draining blood from the lower extremities and '
                        'abdominal organs.',
                        "Primary vessel carrying blood from the lower body to the heart's right "
                        'atrium.',
                        'Main venous conduit returning blood to the heart from below the '
                        'diaphragm.',
                        'Large vein transporting blood from the lower torso and limbs to the '
                        'heart.',
                        'Principal vein bringing deoxygenated blood back to the heart from the '
                        'lower body.',
                        'Main venous channel returning blood from the lower body to the heart.',
                        'Vessel conveying blood from the lower limbs and abdominal organs to the '
                        'heart.',
                        ...
                        'Principal venous return pathway for blood from the lower half of the '
                        'body.',
                        'Primary conduit for deoxygenated blood returning to the heart from the '
                        'lower body.',
                        'Main blood vessel carrying deoxygenated blood from the lower body to the '
                        'heart.',
                        'Major venous vessel draining the lower body and pelvic region.',
                        'Primary venous channel for blood returning to the heart from below the '
                        'diaphragm.',
                        'Key vein returning blood to the heart from the lower extremities and '
                        'abdomen.',
                        'Large blood vessel returning deoxygenated blood from the lower body to '
                        'the heart.',
                        'Main conduit for venous return from the lower body to the heart.'),
 'portal vein and splenic vein': ('Blood vessels carrying nutrient-rich blood from the '
                                  'gastrointestinal tract to the liver.',
                                  'Veins transporting blood from the intestines, stomach, '
                                  'pancreas, and spleen to the liver.',
                                  'Vessels directing blood from the digestive organs and spleen to '
                                  'the liver for processing.',
                                  'Conduits conveying blood from the intestines, pancreas, and '
                                  'spleen to the liver.',
                                  'Vascular pathways transporting blood containing nutrients and '
                                  'toxins to the liver for detoxification.',
                                  'Blood vessels directing blood loaded with absorbed nutrients '
                                  'and waste from the digestive system to the liver.',
                                  'Vascular channels facilitating the transfer of blood from the '
                                  'spleen, pancreas, and gastrointestinal tract to the liver.',
                                  'Vessels enabling the transport of blood from the '
                                  'gastrointestinal organs and spleen to the liver for filtration.',
                                  'Vascular routes for blood to flow from the gastrointestinal '
                                  'system and spleen to the liver.',
                                  'Conduits for blood carrying nutrients and metabolic byproducts '
                                  'from the intestines and spleen to the liver.',
                                  'Vascular pathways delivering blood from the gastrointestinal '
                                  'tract and spleen to the liver for metabolic processing.',
                                  'Veins responsible for transporting blood containing nutrients, '
                                  'toxins, and waste from the digestive system and spleen to the '
                                  'liver.',
                                  'Blood vessels allowing for the transfer of blood from the '
                                  'gastrointestinal system, pancreas, and spleen to the liver.',
                                  'Vascular conduits directing blood from the gastrointestinal '
                                  'organs and spleen to the liver for detoxification and nutrient '
                                  'processing.',
                                  'Veins facilitating the transportation of blood from the '
                                  'gastrointestinal tract, pancreas, and spleen to the liver for '
                                  'metabolic processing.',
                                  'Vascular channels conveying blood from the gastrointestinal '
                                  'organs and spleen to the liver for nutrient absorption and '
                                  'detoxification.',
                                  'Blood vessels transporting blood laden with absorbed nutrients, '
                                  'toxins, and waste from the intestines and spleen to the liver.',
                                  'Vascular routes directing blood from the gastrointestinal '
                                  'system and spleen to the liver for metabolic detoxification and '
                                  'nutrient processing.',
                                  'Conduits allowing for the passage of blood from the '
                                  'gastrointestinal tract, pancreas, and spleen to the liver for '
                                  'metabolic regulation.',
                                  'Vessels serving to transport blood from the gastrointestinal '
                                  'organs and spleen to the liver for detoxification, nutrient '
                                  'processing, and metabolic regulation.'),
 'stones': ('Hard, solid mineral formations in the body.',
 ...
 'artery': ('Blood vessel carrying oxygenated blood away from the heart.',
 ...
 'biliary system': ('Network of ducts and organs involved in bile production and transportation.',
 ...
 'bone': ('Rigid connective tissue forming the skeleton of vertebrates.',
 ...
 'colon': ('Long, tube-shaped organ in the digestive system.',
 ...
 'kidneys': ('Pair of organs responsible for filtering waste from the blood.',
 ...
 'left lung': ('Organ located on the left side of the chest involved in respiration.',
 ...
 'left suprarenal gland': ('Endocrine gland located on the left kidney involved in hormone '
                           'production.',
                           'Glandular structure situated above the left kidney responsible for '
                           'hormone secretion.',
                           'Adrenal gland positioned on the left side of the body involved in '
                           'hormone regulation.',
                           'Glandular organ located adjacent to the left kidney responsible for '
                           'hormone synthesis.',
                           'Left-sided endocrine gland producing hormones involved in stress '
                           'response.',
                           'Glandular tissue situated near the left kidney responsible for hormone '
                           'secretion.',
                           'Endocrine organ found on the left kidney involved in hormone '
                           'synthesis.',
                           'Adrenal structure located on the left side of the body responsible for '
                           'hormone production.',
                           'Glandular structure positioned above the left kidney involved in '
                           'hormone regulation.',
                           'Left-sided adrenal gland producing hormones crucial for physiological '
                           'functions.',
                           'Organ located near the left kidney responsible for hormone secretion.',
                           'Endocrine tissue situated on the left side of the body involved in '
                           'hormone synthesis.',
                           'Glandular organ positioned above the left kidney responsible for '
                           'hormone production.',
                           'Adrenal structure found on the left side of the body crucial for '
                           'hormonal balance.',
                           'Endocrine gland located near the left kidney involved in hormone '
                           'regulation.',
                           'Glandular tissue positioned above the left kidney responsible for '
                           'hormone secretion.',
                           'Left-sided organ producing hormones crucial for metabolic processes.',
                           'Adrenal gland situated on the left side of the body involved in stress '
                           'response.',
                           'Glandular organ located adjacent to the left kidney responsible for '
                           'hormone production.',
                           'Endocrine structure found on the left side of the body involved in '
                           'hormone synthesis.'),
 'left suprarenal tumor': ('Abnormal growth located near the left kidney.',
 ...
 'liver cyst': ('Fluid-filled sac within the liver tissue.',
 ...
 'liver kyst': ('Fluid-filled sac within the liver tissue.',
                'Cavity filled with fluid located in the liver.',
                'Pouch containing fluid that forms in the liver.',
                'Enclosed sac filled with fluid found in the liver.',
                'Fluid-filled structure developing within liver tissue.',
                ...
                'Spherical sac filled with fluid located in the liver.',
                'Enclosed cavity filled with fluid that forms in the liver.'),
 'liver kyste': ('Fluid-filled sac within the liver tissue.',
                 'Cavity filled with fluid located in the liver.',
                 'Pouch containing fluid that forms in the liver.',
                 'Enclosed sac filled with fluid found in the liver.',
                 'Fluid-filled structure developing within liver tissue.',
                 ...
                 'Spherical sac filled with fluid located in the liver.',
                 'Enclosed cavity filled with fluid that forms in the liver.'),
 'liver tumor': ('Abnormal growth in liver tissue.',
                 ...
                 'Pathological growth occurring in liver tissue.',
                 'Anomaly of tissue growth within the liver.'),
 'liver tumor 01': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 02': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 03': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 04': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 05': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 06': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 07': ('Abnormal growth in liver tissue.',
                    'Mass of cells forming in the liver.',
                    'Neoplastic lesion found in the liver.',
                    'Pathological growth occurring in liver tissue.',
                    'Uncontrolled cell proliferation in the liver.',
                    ...
                    'Pathological growth occurring in liver tissue.',
                    'Anomaly of tissue growth within the liver.'),
 'liver tumor 1': ('Abnormal growth in liver tissue.',
                   'Mass of cells forming in the liver.',
                   'Neoplastic lesion found in the liver.',
                   'Pathological growth occurring in liver tissue.',
                   'Uncontrolled cell proliferation in the liver.',
                   ...
                   'Pathological growth occurring in liver tissue.',
                   'Anomaly of tissue growth within the liver.'),
 'liver tumor 2': ('Abnormal growth in liver tissue.',
                   'Mass of cells forming in the liver.',
                   'Neoplastic lesion found in the liver.',
                   'Pathological growth occurring in liver tissue.',
                   'Uncontrolled cell proliferation in the liver.',
                   ...
                   'Pathological growth occurring in liver tissue.',
                   'Anomaly of tissue growth within the liver.'),
 'liver tumors': ('Abnormal growth in liver tissue.',
                  'Mass of cells forming in the liver.',
                  'Neoplastic lesion found in the liver.',
                  'Pathological growth occurring in liver tissue.',
                  'Uncontrolled cell proliferation in the liver.',
                  ...
                  'Pathological growth occurring in liver tissue.',
                  'Anomaly of tissue growth within the liver.'),
 'lungs': ('Organs responsible for respiration.',
 ...
 'metal': ('Solid material with metallic properties.',
 ...
 'metastasectomie': ('Surgical removal of metastatic tumors.',
 ...
 'portal vein': ('Vein carrying blood from digestive organs to the liver.',
 ...
 'portal vein 1': ('Vein carrying blood from digestive organs to the liver.',
                   'Blood vessel connecting gastrointestinal tract to liver.',
                   'Vein transporting blood from intestines to liver.',
                   'Vascular conduit linking digestive system to liver.',
                   'Blood vessel conveying nutrients from intestines to liver.',
                   ...
                   'Blood vessel transporting blood from gastrointestinal system to liver.',
                   'Vascular structure carrying blood from digestive system to liver.'),
 'right lung': ('Respiratory organ located on the right side of the chest.',
 ...
 'right suprarenal gland': ('Adrenal gland located on the right side of the body.',
                            ...
                            'Endocrine gland located on the right side of the abdomen.'),
 'right suprarenal tumor': ('Abnormal growth located on the right adrenal gland.',
                            ...
                            'Cellular proliferation leading to a mass in the right suprarenal '
                            'area.',
 ...
 'small intestin': ('Part of the digestive tract after the stomach.',
 ...
 'suprarenal gland': ('Endocrine organ located above the kidneys.',
 ...
 'uterus': ('Organ where fetal development occurs in females.',
 ...
 'venous system': ('Network of veins responsible for returning blood to the heart.',
 ...
 'adrenal gland left': ('Gland located on the left side of the body near the kidney.',
                        ...
                        'Organ responsible for hormone secretion on the left side near the '
                        'kidney.'),
 'adrenal gland right': ('Gland located on the right side of the body near the kidney.',
                         ...
                         'Organ responsible for hormone secretion on the right side near the '
                         'kidney.'),
 'autochthon left': ('The left part of a geological formation or layer that has not been '
                     'displaced.',
                     ...
                     'Features of the left side of geological formations in their original '
                     'position.',
 ...
 'autochthon right': ('The right part of a geological formation or layer that has not been '
                      'displaced.',
                      ...
                      'The unchanged or undisturbed portion of geological strata on the right '
                      'side.',
                      'Features of the right side of geological formations in their original '
                      'position.',
                      'Unmoved or undisturbed geological layers on the right side.',
                      'Native or original geological components on the right side.',
                      'Elements of the right side of geological formations in their original '
                      'state.',
                      ...
                      'Geological components located on the right side in their original '
                      'condition.',
 ...
 'brain': ('Central organ of the nervous system responsible for cognition and control of bodily '
           'functions.',
           'Complex organ housed within the skull responsible for processing sensory information '
           'and controlling body functions.',
           'Command center of the nervous system responsible for processing information and '
           'coordinating bodily activities.',
           'Highly organized mass of nerve tissue enclosed within the skull responsible for '
           'cognitive functions and regulating body processes.',
           'Principal organ of the central nervous system involved in sensory perception, '
           'cognition, and motor control.',
           'Main component of the central nervous system responsible for processing stimuli and '
           'generating responses.',
           'Primary organ of the nervous system responsible for cognitive processes and motor '
           'coordination.',
           'Large, intricate organ located within the skull responsible for processing sensory '
           'inputs, generating thoughts, and controlling movements.',
           'Central structure of the nervous system responsible for processing information, '
           'initiating actions, and regulating bodily functions.',
           'Complex network of neurons enclosed within the skull responsible for consciousness, '
           'memory, and voluntary movements.',
           'Master control center of the body responsible for interpreting sensory information, '
           'generating responses, and maintaining homeostasis.',
           'Highly developed organ of the central nervous system responsible for coordinating '
           'bodily functions and cognitive processes.',
           'Organ within the skull comprising neurons and supporting cells responsible for '
           'perception, cognition, and behavior.',
           'Principal component of the central nervous system responsible for integrating sensory '
           'inputs and generating appropriate responses.',
           'Primary organ of the central nervous system responsible for processing, storing, and '
           'retrieving information.',
           'Commanding organ of the central nervous system responsible for receiving, processing, '
           'and interpreting sensory information.',
           'Critical organ within the skull responsible for processing information, controlling '
           'movements, and regulating bodily functions.',
           'Intricate organ housed within the cranial cavity responsible for consciousness, '
           'thought, and motor control.',
           'Central processing unit of the nervous system responsible for coordinating all bodily '
           'functions and behaviors.',
           'Major organ of the central nervous system responsible for perception, thought, and '
           'voluntary actions.'),
 'clavicula left': ("Bone located on the left side of the body's upper chest, connecting the "
                    'sternum and shoulder blade.',
                    'Long, slender bone situated on the left side of the upper chest, forming part '
                    'of the shoulder girdle.',
                    'Curved bone on the left side of the upper chest, connecting the sternum and '
                    'shoulder blade.',
                    'Collarbone on the left side of the body, extending from the sternum to the '
                    'shoulder blade.',
                    'Left-sided bone running horizontally between the sternum and shoulder blade.',
                    'Bone positioned on the left side of the upper chest, serving as a connection '
                    'between the sternum and shoulder.',
                    'S-shaped bone on the left side of the body, connecting the sternum and '
                    'shoulder joint.',
                    'Left clavicle forming part of the shoulder girdle, linking the sternum and '
                    'shoulder blade.',
                    'Bone on the left side of the upper chest, articulating with the sternum and '
                    'shoulder blade.',
                    'Left collarbone connecting the sternum and shoulder blade, aiding in shoulder '
                    'movement.',
                    "Bone located on the left side of the body's upper chest, providing support to "
                    'the shoulder.',
                    ...
                    'Bony structure on the left side of the upper chest, aiding in shoulder '
                    'stability.',
                    'Left clavicle serving as a bony bridge between the sternum and shoulder '
                    'joint.',
                    "Bone on the left side of the body's upper chest, contributing to shoulder "
                    'movement.',
                    'Skeletal element on the left side of the upper chest, supporting shoulder '
                    'function.',
                    'Left-sided bone connecting the sternum and shoulder blade, involved in arm '
                    'mobility.',
 ...
 'clavicula right': ("Bone located on the right side of the body's upper chest, connecting the "
                     'sternum and shoulder blade.',
                     'Long, slender bone situated on the right side of the upper chest, forming '
                     'part of the shoulder girdle.',
                     'Curved bone on the right side of the upper chest, connecting the sternum and '
                     'shoulder blade.',
                     'Collarbone on the right side of the body, extending from the sternum to the '
                     'shoulder blade.',
                     'Right-sided bone running horizontally between the sternum and shoulder '
                     'blade.',
                     'Bone positioned on the right side of the upper chest, serving as a '
                     'connection between the sternum and shoulder.',
                     'S-shaped bone on the right side of the body, connecting the sternum and '
                     'shoulder joint.',
                     'Right clavicle forming part of the shoulder girdle, linking the sternum and '
                     'shoulder blade.',
                     'Bone on the right side of the upper chest, articulating with the sternum and '
                     'shoulder blade.',
                     'Right collarbone connecting the sternum and shoulder blade, aiding in '
                     'shoulder movement.',
                     "Bone located on the right side of the body's upper chest, providing support "
                     'to the shoulder.',
                     ...
                     'Bony structure on the right side of the upper chest, aiding in shoulder '
                     'stability.',
                     'Right clavicle serving as a bony bridge between the sternum and shoulder '
                     'joint.',
                     "Bone on the right side of the body's upper chest, contributing to shoulder "
                     'movement.',
                     'Skeletal element on the right side of the upper chest, supporting shoulder '
                     'function.',
                     'Right-sided bone connecting the sternum and shoulder blade, involved in arm '
                     'mobility.',
 ...
 'face': ('Front part of the head, containing the eyes, nose, mouth, and chin.',
          ...
          'External part of the head encompassing the features responsible for perception and '
          'expression.',
          ...
          'Anterior portion of the head containing the structures involved in perception and '
          'communication.'),
 'femur left': ("Long bone in the left thigh, the body's largest bone and a major component of the "
                'leg.',
                ...
                "Major bone of the left thigh, forming part of the lower limb's skeletal "
                'framework.',
                ...
                'Principal structural element in the left thigh, involved in weight support and '
                'movement.',
                "Dominant bone in the left thigh, integral to the skeletal system's lower limb.",
                "Main bone in the left thigh, supporting the body's weight and enabling "
                'ambulation.',
                ...
                'Predominant bone in the left thigh, essential for lower limb function and '
                'mobility.',
                'Primary structural component of the left thigh, crucial for bipedal movement.',
                'Key anatomical feature of the left thigh, facilitating leg movement and '
                'stability.',
                'Principal skeletal element in the left thigh, vital for ambulation and weight '
                'support.',
                ...
                'Chief skeletal component of the left thigh, integral for lower limb '
                'biomechanics.'),
 'femur right': ("Long bone in the right thigh, the body's largest bone and a major component of "
                 'the leg.',
                 'Largest bone in the right thigh, supporting body weight and facilitating '
                 'movement.',
                 ...
                 "Major bone of the right thigh, forming part of the lower limb's skeletal "
                 'framework.',
                 ...
                 'Principal structural element in the right thigh, involved in weight support and '
                 'movement.',
                 "Dominant bone in the right thigh, integral to the skeletal system's lower limb.",
                 "Main bone in the right thigh, supporting the body's weight and enabling "
                 'ambulation.',
                 ...
                 'Predominant bone in the right thigh, essential for lower limb function and '
                 'mobility.',
                 'Primary structural component of the right thigh, crucial for bipedal movement.',
                 'Key anatomical feature of the right thigh, facilitating leg movement and '
                 'stability.',
                 'Principal skeletal element in the right thigh, vital for ambulation and weight '
                 'support.',
                 'Major structural unit of the right thigh, contributing to lower limb mechanics.',
                 'Primary weight-bearing bone in the right thigh, essential for bipedal '
                 'locomotion.',
                 'Main support structure in the right thigh, crucial for standing and walking.',
                 'Chief skeletal component of the right thigh, integral for lower limb '
                 'biomechanics.'),
 'gluteus maximus left': ('Large muscle on the left side of the buttocks, involved in hip '
                          'extension and external rotation. Size: maximus.',
                          'Muscle located on the left side of the buttocks, responsible for hip '
                          'extension and abduction. Size: maximus.',
                          'Prominent muscle in the left buttock region, facilitating hip extension '
                          'and lateral movement. Size: maximus.',
                          'Muscle on the left side of the buttocks, important for hip extension '
                          'and stabilization. Size: maximus.',
                          'Principal muscle in the left buttock, crucial for activities like '
                          'walking, running, and climbing. Size: maximus.',
                          'Major muscle in the left buttock, contributing to hip movement and '
                          'stability. Size: maximus.',
                          'Key muscle on the left side of the buttocks, involved in various lower '
                          'body movements. Size: maximus.',
                          'Primary muscle in the left buttock area, essential for posture and '
                          'locomotion. Size: maximus.',
                          'Dominant muscle on the left side of the buttocks, integral for lower '
                          'limb function. Size: maximus.',
                          'Principal gluteal muscle on the left side, aiding in hip extension and '
                          'pelvic stabilization. Size: maximus.',
                          'Chief muscle in the left buttock region, pivotal for activities '
                          'requiring lower body strength. Size: maximus.',
                          'Predominant muscle on the left side of the buttocks, crucial for hip '
                          'movement. Size: maximus.',
                          'Key anatomical feature in the left buttock, important for hip function '
                          'and stability. Size: maximus.',
                          'Major muscle group in the left buttock area, vital for lower body '
                          'mechanics. Size: maximus.',
                          'Principal muscular structure in the left buttock, facilitating various '
                          'movements. Size: maximus.',
                          'Prominent anatomical component in the left buttock, essential for '
                          'bipedal locomotion. Size: maximus.',
                          'Primary muscle group in the left gluteal region, crucial for '
                          'maintaining upright posture. Size: maximus.',
                          'Key muscular structure on the left side of the buttocks, aiding in hip '
                          'mobility. Size: maximus.',
                          'Chief anatomical feature in the left gluteal region, involved in '
                          'weight-bearing activities. Size: maximus.',
                          'Predominant muscle group on the left side, important for lower limb '
                          'biomechanics. Size: maximus.'),
 'gluteus maximus right': ('Large muscle on the right side of the buttocks, involved in hip '
                           'extension and external rotation. Size: maximus.',
                           'Muscle located on the right side of the buttocks, responsible for hip '
                           'extension and abduction. Size: maximus.',
                           'Prominent muscle in the right buttock region, facilitating hip '
                           'extension and lateral movement. Size: maximus.',
                           'Muscle on the right side of the buttocks, important for hip extension '
                           'and stabilization. Size: maximus.',
                           'Principal muscle in the right buttock, crucial for activities like '
                           'walking, running, and climbing. Size: maximus.',
                           'Major muscle in the right buttock, contributing to hip movement and '
                           'stability. Size: maximus.',
                           'Key muscle on the right side of the buttocks, involved in various '
                           'lower body movements. Size: maximus.',
                           'Primary muscle in the right buttock area, essential for posture and '
                           'locomotion. Size: maximus.',
                           'Dominant muscle on the right side of the buttocks, integral for lower '
                           'limb function. Size: maximus.',
                           'Principal gluteal muscle on the right side, aiding in hip extension '
                           'and pelvic stabilization. Size: maximus.',
                           'Chief muscle in the right buttock region, pivotal for activities '
                           'requiring lower body strength. Size: maximus.',
                           'Predominant muscle on the right side of the buttocks, crucial for hip '
                           'movement. Size: maximus.',
                           'Key anatomical feature in the right buttock, important for hip '
                           'function and stability. Size: maximus.',
                           'Major muscle group in the right buttock area, vital for lower body '
                           'mechanics. Size: maximus.',
                           'Principal muscular structure in the right buttock, facilitating '
                           'various movements. Size: maximus.',
                           'Prominent anatomical component in the right buttock, essential for '
                           'bipedal locomotion. Size: maximus.',
                           'Primary muscle group in the right gluteal region, crucial for '
                           'maintaining upright posture. Size: maximus.',
                           'Key muscular structure on the right side of the buttocks, aiding in '
                           'hip mobility. Size: maximus.',
                           'Chief anatomical feature in the right gluteal region, involved in '
                           'weight-bearing activities. Size: maximus.',
                           'Predominant muscle group on the right side, important for lower limb '
                           'biomechanics. Size: maximus.'),
 'gluteus medius left': ('Muscle on the left side of the buttocks, aiding in hip abduction and '
                         'stabilization. Size: medius.',
                         'Key muscle located on the left side of the pelvis, essential for hip '
                         'stability and balance. Size: medius.',
                         'Prominent muscle in the left buttock region, facilitating lateral '
                         'movement of the hip. Size: medius.',
                         'Muscle in the left gluteal area, crucial for pelvic stability during '
                         'walking and running. Size: medius.',
                         'Principal muscle on the left side of the pelvis, important for hip joint '
                         'integrity. Size: medius.',
                         'Major muscle group in the left buttock, contributing to hip abduction '
                         'and rotation. Size: medius.',
                         'Key muscular structure in the left gluteal region, vital for maintaining '
                         'posture. Size: medius.',
                         'Primary muscle in the left buttock, playing a significant role in gait '
                         'and posture. Size: medius.',
                         'Principal gluteal muscle on the left side, crucial for hip joint '
                         'function. Size: medius.',
                         'Chief muscle in the left buttock area, pivotal for pelvic stabilization '
                         'during locomotion. Size: medius.',
                         'Predominant muscle on the left side, essential for maintaining pelvic '
                         'alignment. Size: medius.',
                         'Primary muscle group in the left hip region, important for pelvic '
                         'stability. Size: medius.',
                         'Key anatomical feature in the left gluteal region, aiding in lateral '
                         'movement of the hip. Size: medius.',
                         'Major muscle in the left buttock, essential for activities like walking '
                         'and climbing stairs. Size: medius.',
                         'Principal muscular structure in the left gluteal area, involved in '
                         'weight-bearing. Size: medius.',
                         'Prominent anatomical component in the left buttock, crucial for hip '
                         'joint function. Size: medius.',
                         'Chief muscle group on the left side, important for maintaining balance '
                         'during movement. Size: medius.',
                         'Predominant muscle in the left gluteal region, aiding in hip abduction. '
                         'Size: medius.',
                         'Key muscular structure on the left side, essential for stability during '
                         'weight-bearing activities. Size: medius.',
                         'Principal muscle group in the left buttock, facilitating movement in the '
                         'frontal plane. Size: medius.'),
 'gluteus medius right': ('Muscle on the right side of the buttocks, involved in hip abduction and '
                          'stabilization. Size: medius.',
                          'Key muscle located on the right side of the pelvis, essential for hip '
                          'stability and balance. Size: medius.',
                          'Prominent muscle in the right buttock region, facilitating lateral '
                          'movement of the hip. Size: medius.',
                          'Muscle in the right gluteal area, crucial for pelvic stability during '
                          'walking and running. Size: medius.',
                          'Principal muscle on the right side of the pelvis, important for hip '
                          'joint integrity. Size: medius.',
                          'Major muscle group in the right buttock, contributing to hip abduction '
                          'and rotation. Size: medius.',
                          'Key muscular structure in the right gluteal region, vital for '
                          'maintaining posture. Size: medius.',
                          'Primary muscle in the right buttock, playing a significant role in gait '
                          'and posture. Size: medius.',
                          'Principal gluteal muscle on the right side, crucial for hip joint '
                          'function. Size: medius.',
                          'Chief muscle in the right buttock area, pivotal for pelvic '
                          'stabilization during locomotion. Size: medius.',
                          'Predominant muscle on the right side, essential for maintaining pelvic '
                          'alignment. Size: medius.',
                          'Primary muscle group in the right hip region, important for pelvic '
                          'stability. Size: medius.',
                          'Key anatomical feature in the right gluteal region, aiding in lateral '
                          'movement of the hip. Size: medius.',
                          'Major muscle in the right buttock, essential for activities like '
                          'walking and climbing stairs. Size: medius.',
                          'Principal muscular structure in the right gluteal area, involved in '
                          'weight-bearing. Size: medius.',
                          'Prominent anatomical component in the right buttock, crucial for hip '
                          'joint function. Size: medius.',
                          'Chief muscle group on the right side, important for maintaining balance '
                          'during movement. Size: medius.',
                          'Predominant muscle in the right gluteal region, aiding in hip '
                          'abduction. Size: medius.',
                          'Key muscular structure on the right side, essential for stability '
                          'during weight-bearing activities. Size: medius.',
                          'Principal muscle group in the right buttock, facilitating movement in '
                          'the frontal plane. Size: medius.'),
 'gluteus minimus left': ('Muscle on the left side of the buttocks, responsible for hip '
                          'stabilization and abduction. Size: minimus.',
                          'Key muscle located on the left side of the pelvis, aiding in '
                          'maintaining pelvic stability. Size: minimus.',
                          'Prominent muscle in the left buttock region, facilitating lateral '
                          'movement of the hip. Size: minimus.',
                          'Muscle in the left gluteal area, crucial for pelvic stability during '
                          'walking and running. Size: minimus.',
                          'Principal muscle on the left side of the pelvis, important for hip '
                          'joint integrity. Size: minimus.',
                          'Major muscle group in the left buttock, contributing to hip abduction '
                          'and rotation. Size: minimus.',
                          'Key muscular structure in the left gluteal region, vital for '
                          'maintaining posture. Size: minimus.',
                          'Primary muscle in the left buttock, playing a significant role in gait '
                          'and posture. Size: minimus.',
                          'Principal gluteal muscle on the left side, crucial for hip joint '
                          'function. Size: minimus.',
                          'Chief muscle in the left buttock area, pivotal for pelvic stabilization '
                          'during locomotion. Size: minimus.',
                          'Predominant muscle on the left side, essential for maintaining pelvic '
                          'alignment. Size: minimus.',
                          'Primary muscle group in the left hip region, important for pelvic '
                          'stability. Size: minimus.',
                          'Key anatomical feature in the left gluteal region, aiding in lateral '
                          'movement of the hip. Size: minimus.',
                          'Major muscle in the left buttock, essential for activities like walking '
                          'and climbing stairs. Size: minimus.',
                          'Principal muscular structure in the left gluteal area, involved in '
                          'weight-bearing. Size: minimus.',
                          'Prominent anatomical component in the left buttock, crucial for hip '
                          'joint function. Size: minimus.',
                          'Chief muscle group on the left side, important for maintaining balance '
                          'during movement. Size: minimus.',
                          'Predominant muscle in the left gluteal region, aiding in hip abduction. '
                          'Size: minimus.',
                          'Key muscular structure on the left side, essential for stability during '
                          'weight-bearing activities. Size: minimus.',
                          'Principal muscle group in the left buttock, facilitating movement in '
                          'the frontal plane. Size: minimus.'),
 'gluteus minimus right': ('Muscle on the right side of the buttocks, responsible for hip '
                           'stabilization and abduction. Size: minimus.',
                           'Key muscle located on the right side of the pelvis, aiding in '
                           'maintaining pelvic stability. Size: minimus.',
                           'Prominent muscle in the right buttock region, facilitating lateral '
                           'movement of the hip. Size: minimus.',
                           'Muscle in the right gluteal area, crucial for pelvic stability during '
                           ...
                           'Key muscular structure in the right gluteal region, vital for '
                           'maintaining posture. Size: minimus.',
                           'Primary muscle in the right buttock, playing a significant role in '
                           'gait and posture. Size: minimus.',
                           'Principal gluteal muscle on the right side, crucial for hip joint '
                           'function. Size: minimus.',
                           'Chief muscle in the right buttock area, pivotal for pelvic '
                           'stabilization during locomotion. Size: minimus.',
                           'Predominant muscle on the right side, essential for maintaining pelvic '
                           'alignment. Size: minimus.',
                           'Primary muscle group in the right hip region, important for pelvic '
                           'stability. Size: minimus.',
                           ...
                           'movement of the hip. Size: minimus.',
                           'Major muscle in the right buttock, essential for activities like '
                           'walking and climbing stairs. Size: minimus.',
                           'Principal muscular structure in the right gluteal area, involved in '
                           'weight-bearing. Size: minimus.',
                           'Prominent anatomical component in the right buttock, crucial for hip '
                           'joint function. Size: minimus.',
                           'Chief muscle group on the right side, important for maintaining '
                           'balance during movement. Size: minimus.',
                           'Predominant muscle in the right gluteal region, aiding in hip '
                           'abduction. Size: minimus.',
                           'Key muscular structure on the right side, essential for stability '
                           'during weight-bearing activities. Size: minimus.',
                           'Principal muscle group in the right buttock, facilitating movement in '
                           'the frontal plane. Size: minimus.'),
 'heart atrium left': ('Chamber of the heart on the left side, receiving oxygenated blood from the '
                       'lungs.',
                       'One of the two upper chambers of the heart, situated on the left side.',
                       'Heart chamber located on the left side, receiving blood from the pulmonary '
                       'veins.',
                       'Part of the heart responsible for receiving oxygen-rich blood from the '
                       'lungs.',
                       'Left-sided heart chamber receiving oxygenated blood returning from the '
                       'lungs.',
                       'Heart component on the left side, receiving blood from the pulmonary '
                       'circulation.',
                       'Cardiac chamber on the left side, receiving oxygenated blood from the '
                       'lungs.',
                       'Upper chamber of the heart situated on the left side, receiving pulmonary '
                       'venous blood.',
                       'Heart structure on the left side, receiving oxygen-rich blood from the '
                       'pulmonary veins.',
                       'Left atrium of the heart, receiving oxygenated blood from the pulmonary '
                       'circulation.',
                       'Chamber of the heart located on the left side, receiving blood from the '
                       'lungs.',
                       'Left-sided heart component receiving oxygenated blood from the pulmonary '
                       'veins.',
                       "One of the heart's upper chambers, positioned on the left side.",
                       'Cardiac structure on the left side, receiving blood from the pulmonary '
                       'veins.',
                       ...
                       'Part of the heart on the left side, receiving blood from the pulmonary '
                       'circulation.',
                       'Left-sided heart chamber receiving oxygen-rich blood from the pulmonary '
                       'veins.',
                       'Heart atrial component situated on the left side, receiving pulmonary '
                       'venous blood.',
                       'Cardiac atrium located on the left side, receiving oxygenated blood from '
                       'the lungs.'),
 'heart atrium right': ('Chamber of the heart on the right side, receiving deoxygenated blood from '
                        'the body.',
                        'One of the two upper chambers of the heart, situated on the right side.',
                        'Heart chamber located on the right side, receiving blood from the '
                        'systemic veins.',
                        'Part of the heart responsible for receiving oxygen-poor blood from the '
                        'body.',
                        'Right-sided heart chamber receiving deoxygenated blood returning from the '
                        'body.',
                        'Heart component on the right side, receiving blood from the systemic '
                        'circulation.',
                        'Cardiac chamber on the right side, receiving deoxygenated blood from the '
                        'body.',
                        'Upper chamber of the heart situated on the right side, receiving systemic '
                        'venous blood.',
                        'Heart structure on the right side, receiving oxygen-poor blood from the '
                        'systemic veins.',
                        'Right atrium of the heart, receiving deoxygenated blood from the systemic '
                        'circulation.',
                        'Chamber of the heart located on the right side, receiving blood from the '
                        'body.',
                        'Right-sided heart component receiving oxygen-poor blood from the systemic '
                        'veins.',
                        "One of the heart's upper chambers, positioned on the right side.",
                        'Cardiac structure on the right side, receiving blood from the systemic '
                        'veins.',
                        'Heart chamber on the right side, receiving deoxygenated blood from the '
                        'body.',
                        'Right atrium of the heart, receiving oxygen-poor blood from the body.',
                        'Part of the heart on the right side, receiving blood from the systemic '
                        'circulation.',
                        'Right-sided heart chamber receiving oxygen-poor blood from the systemic '
                        'veins.',
                        'Heart atrial component situated on the right side, receiving systemic '
                        'venous blood.',
                        'Cardiac atrium located on the right side, receiving deoxygenated blood '
                        'from the body.'),
 'heart myocardium': ('Muscular tissue layer of the heart responsible for its contraction.',
                      ...
                      'Tissue layer forming the muscular wall of the heart, facilitating its '
                      'pumping action.',
                      ...
                      'Muscular tissue surrounding the chambers of the heart, aiding in its '
                      'pumping action.',
                      ...
                      'Tissue layer in the heart composed of cardiac muscle cells, enabling its '
                      'contraction.',
 ...
 'heart ventricle left': ('Chamber of the heart that receives blood from the left atrium and pumps '
                          'it to the body.',
                          'Lower left chamber of the heart responsible for pumping oxygenated '
                          'blood to the body.',
                          'Heart chamber that receives oxygenated blood from the left atrium and '
                          'pumps it to the body.',
                          'Left-sided heart chamber that pumps oxygen-rich blood to the rest of '
                          'the body.',
                          'Ventricular chamber on the left side of the heart responsible for '
                          'systemic circulation.',
                          "Heart's left ventricular chamber responsible for pumping oxygenated "
                          'blood to tissues.',
                          "Chamber of the heart that pumps oxygenated blood to the body's systemic "
                          'circulation.',
                          'Left heart chamber that receives blood from the left atrium and pumps '
                          'it to the body.',
                          'Ventricle on the left side of the heart that pumps oxygenated blood to '
                          'the systemic circulation.',
                          'Lower chamber of the left side of the heart responsible for systemic '
                          'blood circulation.',
                          "Heart's left ventricle, which pumps oxygen-rich blood to the body's "
                          'tissues.',
                          'Chamber of the heart that pumps oxygenated blood to various parts of '
                          'the body.',
                          'Left ventricular chamber responsible for pumping oxygenated blood to '
                          'body tissues.',
                          'Lower chamber of the heart on the left side responsible for systemic '
                          'blood flow.',
                          'Ventricle in the left side of the heart responsible for pumping blood '
                          'to the body.',
                          'Heart chamber on the left side that pumps oxygenated blood to the '
                          'systemic circulation.',
                          "Left-sided heart chamber that pumps oxygen-rich blood to the body's "
                          'tissues.',
                          "Chamber in the heart's left side responsible for pumping blood to the "
                          "body's tissues.",
                          'Left ventricle responsible for pumping oxygenated blood to the body.',
                          "Heart's ventricular chamber that pumps oxygen-rich blood to the body's "
                          'organs.'),
 'heart ventricle right': ('Chamber of the heart that receives blood from the right atrium and '
                           'pumps it to the lungs.',
                           'Lower right chamber of the heart responsible for pumping deoxygenated '
                           'blood to the lungs.',
                           'Heart chamber that receives deoxygenated blood from the right atrium '
                           'and pumps it to the lungs.',
                           'Right-sided heart chamber that pumps deoxygenated blood to the lungs '
                           'for oxygenation.',
                           'Ventricle on the right side of the heart responsible for pulmonary '
                           'circulation.',
                           "Heart's right ventricular chamber responsible for pumping blood to the "
                           'lungs for oxygenation.',
                           'Chamber of the heart that pumps deoxygenated blood to the pulmonary '
                           'circulation.',
                           'Right heart chamber that receives blood from the right atrium and '
                           'pumps it to the lungs.',
                           'Ventricle on the right side of the heart that pumps deoxygenated blood '
                           'to the lungs.',
                           'Lower chamber of the right side of the heart responsible for pulmonary '
                           'blood circulation.',
                           "Heart's right ventricle, which pumps deoxygenated blood to the lungs.",
                           'Chamber of the heart that pumps deoxygenated blood to the lungs for '
                           'oxygenation.',
                           'Right ventricular chamber responsible for pumping deoxygenated blood '
                           'to the lungs.',
                           'Lower chamber of the heart on the right side responsible for pulmonary '
                           'blood flow.',
                           'Ventricle in the right side of the heart responsible for pumping blood '
                           'to the lungs.',
                           'Heart chamber on the right side that pumps deoxygenated blood to the '
                           'lungs for oxygenation.',
                           'Right-sided heart chamber that pumps deoxygenated blood to the lungs '
                           'for oxygenation.',
                           "Chamber in the heart's right side responsible for pumping blood to the "
                           'lungs for oxygenation.',
                           'Right ventricle responsible for pumping deoxygenated blood to the '
                           'lungs.',
                           "Heart's ventricular chamber that pumps deoxygenated blood to the lungs "
                           'for oxygenation.'),
 'hip left': ('The left side of the pelvic region where the thigh bone meets the pelvis.',
 ...
 'hip right': ('The right side of the pelvic region where the thigh bone meets the pelvis.',
               ...
               'The right hip area, including the ball-and-socket joint connecting thigh and '
               'pelvis.',
 ...
 'humerus left': ('The left upper arm bone connecting the shoulder to the elbow.',
 ...
 'humerus right': ('The right upper arm bone connecting the shoulder to the elbow.',
 ...
 'iliac artery left': ('Artery on the left side of the pelvis, supplying blood to the lower limbs.',
                       'Vessel carrying oxygenated blood to the left lower extremity from the '
                       'aorta.',
                       'Left-sided artery originating from the abdominal aorta, supplying the left '
                       'leg.',
                       'Arterial vessel branching from the abdominal aorta, feeding the left lower '
                       'limb.',
                       'Blood vessel on the left side of the body, delivering blood to the left '
                       'leg.',
                       'Artery arising from the abdominal aorta, providing blood to the left lower '
                       'limb.',
                       'Left iliac artery, distributing oxygen-rich blood to the left lower '
                       'extremity.',
                       ...
                       'Vessel originating from the abdominal aorta, nourishing the left lower '
                       'limb.',
                       'Arterial vessel supplying the left leg, originating from the abdominal '
                       'aorta.',
                       ...
                       'Left-sided artery originating from the aorta, providing blood to the lower '
                       'limb.',
                       'Artery branching from the aorta, distributing blood to the left lower '
                       'limb.',
                       'Vessel supplying blood to the left lower limb, arising from the abdominal '
                       'aorta.'),
 'iliac artery right': ('Artery on the right side of the pelvis, supplying blood to the lower '
                        'limbs.',
                        'Vessel carrying oxygenated blood to the right lower extremity from the '
                        'aorta.',
                        'Right-sided artery originating from the abdominal aorta, supplying the '
                        'right leg.',
                        'Arterial vessel branching from the abdominal aorta, feeding the right '
                        'lower limb.',
                        'Blood vessel on the right side of the body, delivering blood to the right '
                        'leg.',
                        'Artery arising from the abdominal aorta, providing blood to the right '
                        'lower limb.',
                        'Right iliac artery, distributing oxygen-rich blood to the right lower '
                        'extremity.',
                        'Vessel originating from the aorta, supplying blood to the right lower '
                        'limb.',
                        'Artery in the right pelvic region, delivering blood to the right lower '
                        'limb.',
                        ...
                        'Vessel originating from the abdominal aorta, nourishing the right lower '
                        'limb.',
                        'Arterial vessel supplying the right leg, originating from the abdominal '
                        'aorta.',
                        'Right iliac artery, transporting oxygenated blood to the right lower '
                        'limb.',
                        ...
                        'Right-sided artery originating from the aorta, providing blood to the '
                        'lower limb.',
                        'Artery branching from the aorta, distributing blood to the right lower '
                        'limb.',
                        'Vessel supplying blood to the right lower limb, arising from the '
                        'abdominal aorta.'),
 'iliac vena left': ('Vein on the left side of the pelvis, returning blood from the lower limbs to '
                     'the heart.',
                     'Vessel carrying deoxygenated blood from the left lower extremity to the vena '
                     'cava.',
                     'Left-sided vein draining blood from the left leg to the inferior vena cava.',
                     'Vein transporting deoxygenated blood from the left lower limb to the vena '
                     'cava.',
                     'Blood vessel on the left side of the body, returning blood from the left '
                     'leg.',
                     'Vein receiving blood from the left lower extremity, ultimately returning it '
                     'to the heart.',
                     'Left iliac vein, carrying deoxygenated blood from the left lower limb to the '
                     'vena cava.',
                     'Vessel collecting blood from the left leg, eventually draining into the vena '
                     'cava.',
                     'Vein in the left pelvic region, returning blood from the left lower limb to '
                     'the heart.',
                     'Left-sided venous vessel draining blood from the left leg to the heart.',
                     'Blood vessel on the left side, returning blood from the lower limb to the '
                     'heart.',
                     ...
                     'Left iliac vein, transporting blood from the left lower limb to the vena '
                     'cava.',
                     'Vessel draining blood from the left leg, leading to the vena cava.',
                     'Vein in the left pelvis, returning blood from the left lower limb to the '
                     'heart.',
                     'Left-sided vein carrying deoxygenated blood from the lower limb to the vena '
                     'cava.',
                     'Venous vessel draining blood from the leg on the left side of the body.',
                     'Blood vessel in the left pelvic region, returning blood from the left lower '
                     'limb.'),
 'iliac vena right': ('Vein on the right side of the pelvis, returning blood from the lower limbs '
                      'to the heart.',
                      'Vessel carrying deoxygenated blood from the right lower extremity to the '
                      'vena cava.',
                      'Right-sided vein draining blood from the right leg to the inferior vena '
                      'cava.',
                      'Vein transporting deoxygenated blood from the right lower limb to the vena '
                      'cava.',
                      'Blood vessel on the right side of the body, returning blood from the right '
                      'leg.',
                      'Vein receiving blood from the right lower extremity, ultimately returning '
                      'it to the heart.',
                      'Right iliac vein, carrying deoxygenated blood from the right lower limb to '
                      'the vena cava.',
                      'Vessel collecting blood from the right leg, eventually draining into the '
                      'vena cava.',
                      'Vein in the right pelvic region, returning blood from the right lower limb '
                      'to the heart.',
                      'Right-sided venous vessel draining blood from the right leg to the heart.',
                      'Blood vessel on the right side, returning blood from the lower limb to the '
                      'heart.',
                      'Vein draining blood from the right lower extremity, leading to the vena '
                      'cava.',
                      'Vessel carrying blood from the right lower limb to the vena cava.',
                      'Venous vessel receiving blood from the right leg, returning it to the '
                      'heart.',
                      'Right iliac vein, transporting blood from the right lower limb to the vena '
                      'cava.',
                      'Vessel draining blood from the right leg, leading to the vena cava.',
                      'Vein in the right pelvis, returning blood from the right lower limb to the '
                      'heart.',
                      'Right-sided vein carrying deoxygenated blood from the lower limb to the '
                      'vena cava.',
                      'Venous vessel draining blood from the leg on the right side of the body.',
                      'Blood vessel in the right pelvic region, returning blood from the right '
                      'lower limb.'),
 'iliopsoas left': ('Muscle group located on the left side of the body, composed of the psoas '
                    'major and iliacus muscles.',
                    'Combination of muscles on the left side including the psoas major and iliacus '
                    'muscles.',
                    'Left-sided muscle group comprising the psoas major and iliacus muscles, '
                    'involved in hip flexion.',
                    'Muscles on the left side responsible for flexing the hip joint, consisting of '
                    'the psoas major and iliacus.',
                    'Group of muscles on the left side of the body, aiding in hip flexion, '
                    'consisting of the psoas major and iliacus.',
                    'Left iliac muscle complex, comprising the psoas major and iliacus, involved '
                    'in hip movement.',
                    'Muscles located on the left side of the body, including the psoas major and '
                    'iliacus, facilitating hip flexion.',
                    'Left-sided muscle bundle consisting of the psoas major and iliacus, assisting '
                    'in hip flexion.',
                    'Muscle group on the left side, composed of the psoas major and iliacus, '
                    'contributing to hip flexion.',
                    'Left iliac muscles, comprising the psoas major and iliacus, responsible for '
                    'flexing the hip joint.',
                    'Left muscle complex involving the psoas major and iliacus, facilitating '
                    'movement at the hip joint.',
                    'Muscles on the left side of the body, including the psoas major and iliacus, '
                    'assisting in hip flexion.',
                    'Left-sided muscle bundle comprising the psoas major and iliacus, aiding in '
                    'flexion of the hip joint.',
                    'Group of left-sided muscles, including the psoas major and iliacus, involved '
                    'in hip flexion.',
                    'Left iliac muscle group, consisting of the psoas major and iliacus, '
                    'facilitating movement at the hip.',
                    'Muscle complex on the left side, composed of the psoas major and iliacus, '
                    'contributing to hip flexion.',
                    'Left-sided muscles comprising the psoas major and iliacus, involved in '
                    'flexing the hip.',
                    'Muscle bundle on the left side, including the psoas major and iliacus, aiding '
                    'in hip flexion.',
                    'Left iliac muscle unit, composed of the psoas major and iliacus, responsible '
                    'for hip flexion.',
                    'Muscles located on the left side, comprising the psoas major and iliacus, '
                    'facilitating hip flexion.'),
 'iliopsoas right': ('Muscle group located on the right side of the body, composed of the psoas '
                     'major and iliacus muscles.',
                     'Combination of muscles on the right side including the psoas major and '
                     'iliacus muscles.',
                     'Right-sided muscle group comprising the psoas major and iliacus muscles, '
                     'involved in hip flexion.',
                     'Muscles on the right side responsible for flexing the hip joint, consisting '
                     'of the psoas major and iliacus.',
                     'Group of muscles on the right side of the body, aiding in hip flexion, '
                     'consisting of the psoas major and iliacus.',
                     'Right iliac muscle complex, comprising the psoas major and iliacus, involved '
                     'in hip movement.',
                     'Muscles located on the right side of the body, including the psoas major and '
                     'iliacus, facilitating hip flexion.',
                     'Right-sided muscle bundle consisting of the psoas major and iliacus, '
                     'assisting in hip flexion.',
                     'Muscle group on the right side, composed of the psoas major and iliacus, '
                     'contributing to hip flexion.',
                     'Right iliac muscles, comprising the psoas major and iliacus, responsible for '
                     'flexing the hip joint.',
                     'Right muscle complex involving the psoas major and iliacus, facilitating '
                     'movement at the hip joint.',
                     'Muscles on the right side of the body, including the psoas major and '
                     'iliacus, assisting in hip flexion.',
                     'Right-sided muscle bundle comprising the psoas major and iliacus, aiding in '
                     'flexion of the hip joint.',
                     'Group of right-sided muscles, including the psoas major and iliacus, '
                     'involved in hip flexion.',
                     'Right iliac muscle group, consisting of the psoas major and iliacus, '
                     'facilitating movement at the hip.',
                     'Muscle complex on the right side, composed of the psoas major and iliacus, '
                     'contributing to hip flexion.',
                     'Right-sided muscles comprising the psoas major and iliacus, involved in '
                     'flexing the hip.',
                     'Muscle bundle on the right side, including the psoas major and iliacus, '
                     'aiding in hip flexion.',
                     'Right iliac muscle unit, composed of the psoas major and iliacus, '
                     'responsible for hip flexion.',
                     'Muscles located on the right side, comprising the psoas major and iliacus, '
                     'facilitating hip flexion.'),
 'kidney left': ('Organ located on the left side of the body, responsible for filtering blood and '
                 'producing urine.',
                 'Left-sided organ involved in filtration of blood and excretion of waste as '
                 'urine.',
                 'Renal structure situated on the left side, responsible for filtration and urine '
                 'production.',
                 'Left kidney, a vital organ filtering blood and eliminating waste through urine '
                 'formation.',
                 'Organ on the left side responsible for filtering waste from blood and producing '
                 'urine.',
                 'Left renal organ involved in blood filtration and urine production.',
                 'Kidney situated on the left side, essential for filtering blood and producing '
                 'urine.',
                 ...
                 'Renal organ situated on the left, involved in blood filtration and urine '
                 'excretion.',
 ...
 'kidney right': ('Organ located on the right side of the body, responsible for filtering blood '
                  'and producing urine.',
                  'Right-sided organ involved in filtration of blood and excretion of waste as '
                  'urine.',
                  'Renal structure situated on the right side, responsible for filtration and '
                  'urine production.',
                  'Right kidney, a vital organ filtering blood and eliminating waste through urine '
                  'formation.',
                  'Organ on the right side responsible for filtering waste from blood and '
                  'producing urine.',
                  'Right renal organ involved in blood filtration and urine production.',
                  'Kidney situated on the right side, essential for filtering blood and producing '
                  'urine.',
                  'Right-sided renal structure responsible for blood filtration and urine '
                  'formation.',
                  ...
                  'Renal organ situated on the right, involved in blood filtration and urine '
                  'excretion.',
                  ...
                  'Right kidney, a vital organ responsible for blood filtration and urine '
                  'formation.',
                  ...
                  'Organ located on the right side, filtering waste from blood and producing '
                  'urine.'),
 'lung lower lobe left': ('Lower portion of the left lung responsible for gas exchange during '
                          'breathing.',
                          'Lower lobe on the left side of the chest cavity involved in respiratory '
                          'gas exchange.',
                          'Left lung region located below other lobes, facilitating oxygen '
                          'exchange.',
                          'Lower section of the left lung where gas exchange occurs during '
                          'respiration.',
                          'Left lung lobe situated at the bottom, aiding in oxygen uptake and '
                          ...
                          'Lower segment of the left lung, critical for breathing and oxygen '
                          'transfer.',
                          'Part of the left lung located at the bottom, involved in breathing and '
                          'gas exchange.',
                          'Lower lobe on the left side, integral for oxygen uptake and carbon '
                          'dioxide removal.',
                          'Lower section of the left lung, playing a key role in respiratory '
                          'function.',
                          "Left lung's lower area responsible for exchanging gases during "
                          'respiration.',
                          'Lowermost region of the left lung, facilitating air exchange during '
                          'breathing.',
                          "Left lung's lower portion involved in the exchange of oxygen and carbon "
                          'dioxide.',
                          ...
                          'Lower portion of the left lung where oxygen and carbon dioxide exchange '
                          'occurs.',
                          "Left lung's lowermost lobe responsible for respiratory gas exchange."),
 'lung lower lobe right': ('Lower portion of the right lung involved in gas exchange during '
                           'breathing.',
                           'Lower lobe on the right side of the chest cavity responsible for '
                           'respiratory gas exchange.',
                           'Right lung region located below other lobes, facilitating oxygen and '
                           'carbon dioxide exchange.',
                           'Lower section of the right lung where gas exchange occurs during '
                           'respiration.',
                           'Right lung lobe situated at the bottom, aiding in oxygen uptake and '
                           'carbon dioxide release.',
                           ...
                           'Lower segment of the right lung, critical for breathing and gas '
                           'transfer.',
                           'Part of the right lung located at the bottom, involved in breathing '
                           'and gas exchange.',
                           'Lower lobe on the right side, integral for oxygen uptake and carbon '
                           'dioxide removal.',
                           'Lower section of the right lung, playing a key role in respiratory '
                           'function.',
                           "Right lung's lower area responsible for exchanging gases during "
                           'respiration.',
                           'Lowermost region of the right lung, facilitating air exchange during '
                           'breathing.',
                           "Right lung's lower portion involved in the exchange of oxygen and "
                           'carbon dioxide.',
                           ...
                           'Lower lobe of the right lung, essential for breathing and gas '
                           'transfer.',
                           'Lower segment of the right lung, vital for respiratory function.',
                           'Lower portion of the right lung where oxygen and carbon dioxide '
                           'exchange occurs.',
                           "Right lung's lowermost lobe responsible for respiratory gas exchange."),
 'lung middle lobe right': ('Middle portion of the right lung involved in respiratory gas '
                            'exchange.',
                            'Middle lobe on the right side of the chest cavity essential for '
                            'breathing.',
                            'Right lung region situated between other lobes, facilitating gas '
                            'exchange.',
                            'Middle section of the right lung where oxygen and carbon dioxide '
                            'exchange occurs.',
                            'Right lung lobe located centrally, playing a key role in respiration.',
                            'Intermediate part of the right lung, critical for oxygen uptake and '
                            'carbon dioxide release.',
                            ...
                            'Part of the right lung located centrally, involved in gas exchange '
                            'during breathing.',
                            'Middle lobe on the right side, integral for oxygen uptake and carbon '
                            'dioxide removal.',
                            'Midsection of the right lung, playing a vital role in respiratory '
                            'function.',
                            "Right lung's middle area responsible for exchanging gases during "
                            'respiration.',
                            'Middle region of the right lung, facilitating air exchange during '
                            'breathing.',
                            "Right lung's middle portion involved in the exchange of oxygen and "
                            'carbon dioxide.',
                            'Intermediate part of the right lung essential for respiratory gas '
                            'exchange.',
                            "Right lung's middle lobe, crucial for oxygenation of blood.",
                            'Middle lobe of the right lung, essential for breathing and gas '
                            'transfer.',
                            'Middle segment of the right lung, vital for respiratory function.',
                            'Middle portion of the right lung where oxygen and carbon dioxide '
                            'exchange occurs.',
                            "Right lung's intermediate lobe responsible for respiratory gas "
                            'exchange.'),
 'lung upper lobe left': ('Upper portion of the left lung involved in respiratory gas exchange.',
                          'Upper lobe on the left side of the chest cavity essential for '
                          'breathing.',
                          'Left lung region situated above other lobes, facilitating gas exchange.',
                          'Upper section of the left lung where oxygen and carbon dioxide exchange '
                          'occurs.',
                          'Left lung lobe located superiorly, playing a key role in respiration.',
                          'Superior part of the left lung, critical for oxygen uptake and carbon '
                          'dioxide release.',
                          ...
                          'Part of the left lung located superiorly, involved in gas exchange '
                          'during breathing.',
                          'Upper lobe on the left side, integral for oxygen uptake and carbon '
                          'dioxide removal.',
                          'Superior section of the left lung, playing a vital role in respiratory '
                          'function.',
                          "Left lung's upper area responsible for exchanging gases during "
                          'respiration.',
                          'Upper region of the left lung, facilitating air exchange during '
                          'breathing.',
                          "Left lung's upper portion involved in the exchange of oxygen and carbon "
                          'dioxide.',
                          ...
                          'Upper portion of the left lung where oxygen and carbon dioxide exchange '
                          'occurs.',
                          "Left lung's superior lobe responsible for respiratory gas exchange."),
 'lung upper lobe right': ('Upper portion of the right lung involved in respiratory gas exchange.',
                           'Upper lobe on the right side of the chest cavity essential for '
                           'breathing.',
                           'Right lung region situated above other lobes, facilitating gas '
                           'exchange.',
                           'Upper section of the right lung where oxygen and carbon dioxide '
                           'exchange occurs.',
                           'Right lung lobe located superiorly, playing a key role in respiration.',
                           'Superior part of the right lung, critical for oxygen uptake and carbon '
                           'dioxide release.',
                           ...
                           'Part of the right lung located superiorly, involved in gas exchange '
                           'during breathing.',
                           'Upper lobe on the right side, integral for oxygen uptake and carbon '
                           'dioxide removal.',
                           'Superior section of the right lung, playing a vital role in '
                           'respiratory function.',
                           "Right lung's upper area responsible for exchanging gases during "
                           'respiration.',
                           'Upper region of the right lung, facilitating air exchange during '
                           'breathing.',
                           "Right lung's upper portion involved in the exchange of oxygen and "
                           'carbon dioxide.',
                           'Superior part of the right lung essential for respiratory gas '
                           'exchange.',
                           "Right lung's upper lobe, crucial for oxygenation of blood.",
                           'Upper lobe of the right lung, essential for breathing and gas '
                           'transfer.',
                           'Upper segment of the right lung, vital for respiratory function.',
                           'Upper portion of the right lung where oxygen and carbon dioxide '
                           'exchange occurs.',
                           "Right lung's superior lobe responsible for respiratory gas exchange."),
 'pulmonary artery': ('Blood vessel carrying deoxygenated blood from the heart to the lungs for '
                      'oxygenation.',
                      'Artery that transports blood from the heart to the lungs for oxygenation.',
                      'Vessel responsible for carrying blood from the heart to the lungs for '
                      'oxygen exchange.',
                      'Blood vessel originating from the heart and supplying deoxygenated blood to '
                      'the lungs.',
                      'Arterial vessel connecting the heart to the lungs for oxygenation of blood.',
                      'Large blood vessel conveying deoxygenated blood from the heart to the '
                      'lungs.',
                      'Vessel emanating from the heart and directing blood to the lungs for oxygen '
                      'replenishment.',
                      'Arterial conduit carrying blood from the heart to the pulmonary '
                      'circulation.',
                      'Blood vessel arising from the heart and transporting blood to the lungs for '
                      'oxygenation.',
                      "Vessel originating from the heart's right ventricle and conveying blood to "
                      'the lungs.',
                      'Artery originating from the heart and distributing blood to the pulmonary '
                      'circulation.',
                      "Vessel carrying blood from the heart's right ventricle to the lungs for "
                      'oxygenation.',
                      'Arterial conduit responsible for transporting blood to the lungs from the '
                      'heart.',
                      'Blood vessel emerging from the heart and supplying deoxygenated blood to '
                      'the lungs.',
                      'Artery originating in the heart and directing blood to the lungs for '
                      'oxygenation.',
                      'Vessel originating from the heart and delivering deoxygenated blood to the '
                      'lungs.',
                      'Large arterial vessel conveying blood from the heart to the lungs for '
                      'oxygenation.',
                      'Blood vessel originating from the heart and directing blood to the '
                      'pulmonary circulation.',
                      'Arterial conduit originating from the heart and transporting blood to the '
                      'lungs.',
                      'Vessel originating from the heart and carrying deoxygenated blood to the '
                      'lungs.'),
 'rib left 1': ('First bone on the left side of the chest forming part of the rib cage.',
                'Initial bone on the left side of the thorax, contributing to the rib cage '
                'structure.',
                'Bone situated on the left side of the chest and serving as the first rib.',
                'The first skeletal element on the left side of the chest, forming part of the rib '
                'cage.',
                ...
                'First bony structure on the left side of the thoracic cavity, forming part of the '
                'rib cage.',
                ...
                'The initial skeletal component on the left side of the chest, forming part of the '
                'rib cage.',
                'First osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The foremost bony element on the left side of the chest, part of the rib cage.',
                'Bone located at the front of the left side of the chest, forming part of the rib '
                'cage.',
                'The leading skeletal part on the left side of the thorax, comprising the rib '
                'cage.',
                'First skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The anterior bone on the left side of the thoracic cavity, forming part of the '
                'rib cage.',
                'Bone situated at the forefront of the left side of the chest, serving as the '
                'first rib.',
                'The initial osseous segment on the left side of the thorax, part of the rib cage.',
                'First skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The foremost bony component on the left side of the chest, constituting the rib '
                'cage.'),
 'rib left 10': ('Tenth bone on the left side of the chest, part of the rib cage structure.',
                 'Bone situated on the left side of the thorax, serving as the tenth rib.',
                 'The tenth skeletal element on the left side of the chest, forming part of the '
                 'rib cage.',
                 'The rib located on the left side of the chest, serving as the tenth rib.',
                 'Tenth osseous structure on the left side of the thoracic region, contributing to '
                 'the rib cage.',
                 'The bony element positioned on the left side of the chest, constituting the '
                 'tenth rib.',
                 'Bone located at the front of the left side of the chest, forming part of the rib '
                 'cage.',
                 'The tenth skeletal part on the left side of the thorax, comprising the rib cage.',
                 'Tenth skeletal unit on the left side of the chest, contributing to the rib cage '
                 'structure.',
                 'The rib bone situated at the forefront of the left side of the chest, serving as '
                 'the tenth rib.',
                 'The tenth osseous segment on the left side of the thorax, part of the rib cage.',
                 'Tenth skeletal element on the left side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component located on the left side of the chest, constituting the rib '
                 'cage.',
                 'Bone positioned at the anterior aspect of the left side of the chest, forming '
                 'part of the rib cage.',
                 'The tenth bony unit on the left side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the front of the left side of the chest, serving as the tenth '
                 'rib.',
                 'Tenth osseous component on the left side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the left side of the chest, serving as the anterior component '
                 'of the rib cage.',
                 'Tenth skeletal unit on the left side of the chest, forming part of the rib cage '
                 'structure.',
                 'The bony segment positioned at the forefront of the left side of the chest, '
                 'serving as the tenth rib.'),
 'rib left 11': ('Eleventh bone on the left side of the chest, part of the rib cage structure.',
                 'Bone situated on the left side of the thorax, serving as the eleventh rib.',
                 'The eleventh skeletal element on the left side of the chest, forming part of the '
                 'rib cage.',
                 'The rib located on the left side of the chest, serving as the eleventh rib.',
                 'Eleventh osseous structure on the left side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element positioned on the left side of the chest, constituting the '
                 'eleventh rib.',
                 'Bone located at the front of the left side of the chest, forming part of the rib '
                 'cage.',
                 'The eleventh skeletal part on the left side of the thorax, comprising the rib '
                 'cage.',
                 'Eleventh skeletal unit on the left side of the chest, contributing to the rib '
                 'cage structure.',
                 'The rib bone situated at the forefront of the left side of the chest, serving as '
                 'the eleventh rib.',
                 'The eleventh osseous segment on the left side of the thorax, part of the rib '
                 'cage.',
                 'Eleventh skeletal element on the left side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component located on the left side of the chest, constituting the rib '
                 'cage.',
                 'Bone positioned at the anterior aspect of the left side of the chest, forming '
                 'part of the rib cage.',
                 'The eleventh bony unit on the left side of the thoracic cavity, contributing to '
                 'the rib cage.',
                 'Bone situated at the front of the left side of the chest, serving as the '
                 'eleventh rib.',
                 'Eleventh osseous component on the left side of the chest, forming part of the '
                 'rib cage.',
                 'The rib located on the left side of the chest, serving as the anterior component '
                 'of the rib cage.',
                 'Eleventh skeletal unit on the left side of the chest, forming part of the rib '
                 'cage structure.',
                 'The bony segment positioned at the forefront of the left side of the chest, '
                 'serving as the eleventh rib.'),
 'rib left 12': ('Twelfth bone on the left side of the chest, forming part of the rib cage '
                 'structure.',
                 'Bone situated on the left side of the thorax, serving as the twelfth rib.',
                 'The twelfth skeletal element on the left side of the chest, contributing to the '
                 'rib cage.',
                 'The rib located on the left side of the chest, serving as the twelfth rib.',
                 'Twelfth osseous structure on the left side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element positioned on the left side of the chest, constituting the '
                 'twelfth rib.',
                 'Bone located at the front of the left side of the chest, forming part of the rib '
                 'cage.',
                 'The twelfth skeletal part on the left side of the thorax, comprising the rib '
                 'cage.',
                 'Twelfth skeletal unit on the left side of the chest, contributing to the rib '
                 'cage structure.',
                 'The rib bone situated at the forefront of the left side of the chest, serving as '
                 'the twelfth rib.',
                 'The twelfth osseous segment on the left side of the thorax, part of the rib '
                 'cage.',
                 'Twelfth skeletal element on the left side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component located on the left side of the chest, constituting the rib '
                 'cage.',
                 'Bone positioned at the anterior aspect of the left side of the chest, forming '
                 'part of the rib cage.',
                 'The twelfth bony unit on the left side of the thoracic cavity, contributing to '
                 'the rib cage.',
                 'Bone situated at the front of the left side of the chest, serving as the twelfth '
                 'rib.',
                 'Twelfth osseous component on the left side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the left side of the chest, serving as the anterior component '
                 'of the rib cage.',
                 'Twelfth skeletal unit on the left side of the chest, forming part of the rib '
                 'cage structure.',
                 'The bony segment positioned at the forefront of the left side of the chest, '
                 'serving as the twelfth rib.'),
 'rib left 2': ('Second bone on the left side of the chest, forming part of the rib cage '
                'structure.',
                'Bone situated on the left side of the thorax, serving as the second rib.',
                'The second skeletal element on the left side of the chest, contributing to the '
                'rib cage.',
                'The rib located on the left side of the chest, serving as the second rib.',
                'Second osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element positioned on the left side of the chest, constituting the '
                'second rib.',
                'Bone located at the front of the left side of the chest, forming part of the rib '
                ...
                'Second skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone situated at the forefront of the left side of the chest, serving as '
                'the second rib.',
                'The second osseous segment on the left side of the thorax, part of the rib cage.',
                'Second skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component located on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'The second bony unit on the left side of the thoracic cavity, contributing to the '
                'rib cage.',
                'Bone situated at the front of the left side of the chest, serving as the second '
                'rib.',
                'Second osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Second skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the second rib.'),
 'rib left 3': ('Third bone on the left side of the chest, forming part of the rib cage structure.',
                'Bone situated on the left side of the thorax, serving as the third rib.',
                'The third skeletal element on the left side of the chest, contributing to the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the third rib.',
                'Third osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element positioned on the left side of the chest, constituting the third '
                'rib.',
                'Bone located at the front of the left side of the chest, forming part of the rib '
                'cage.',
                'The third skeletal part on the left side of the thorax, comprising the rib cage.',
                'Third skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone situated at the forefront of the left side of the chest, serving as '
                'the third rib.',
                'The third osseous segment on the left side of the thorax, part of the rib cage.',
                'Third skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component located on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'The third bony unit on the left side of the thoracic cavity, contributing to the '
                'rib cage.',
                'Bone situated at the front of the left side of the chest, serving as the third '
                'rib.',
                'Third osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Third skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the third rib.'),
 'rib left 4': ('Fourth bone on the left side of the chest, forming part of the rib cage '
                'structure.',
                'Bone situated on the left side of the thorax, serving as the fourth rib.',
                'The fourth skeletal element on the left side of the chest, contributing to the '
                'rib cage.',
                'The rib located on the left side of the chest, serving as the fourth rib.',
                'Fourth osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element positioned on the left side of the chest, constituting the '
                'fourth rib.',
                'Bone located at the front of the left side of the chest, forming part of the rib '
                ...
                'Fourth skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone situated at the forefront of the left side of the chest, serving as '
                'the fourth rib.',
                'The fourth osseous segment on the left side of the thorax, part of the rib cage.',
                'Fourth skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component located on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'The fourth bony unit on the left side of the thoracic cavity, contributing to the '
                'rib cage.',
                'Bone situated at the front of the left side of the chest, serving as the fourth '
                'rib.',
                'Fourth osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Fourth skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the fourth rib.'),
 'rib left 5': ('Fifth bone on the left side of the chest, forming part of the rib cage structure.',
                'Bone situated on the left side of the thorax, serving as the fifth rib.',
                'The fifth skeletal element on the left side of the chest, contributing to the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the fifth rib.',
                'Fifth osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element positioned on the left side of the chest, constituting the fifth '
                'rib.',
                'Bone located at the front of the left side of the chest, forming part of the rib '
                'cage.',
                'The fifth skeletal part on the left side of the thorax, comprising the rib cage.',
                'Fifth skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone situated at the forefront of the left side of the chest, serving as '
                'the fifth rib.',
                'The fifth osseous segment on the left side of the thorax, part of the rib cage.',
                'Fifth skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component located on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'The fifth bony unit on the left side of the thoracic cavity, contributing to the '
                'rib cage.',
                'Bone situated at the front of the left side of the chest, serving as the fifth '
                'rib.',
                'Fifth osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Fifth skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the fifth rib.'),
 'rib left 6': ('Sixth bone on the left side of the chest, forming part of the rib cage structure.',
                'Bone situated on the left side of the thorax, serving as the sixth rib.',
                'The sixth skeletal element on the left side of the chest, contributing to the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the sixth rib.',
                'Sixth osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element positioned on the left side of the chest, constituting the sixth '
                'rib.',
                'Bone located at the front of the left side of the chest, forming part of the rib '
                'cage.',
                'The sixth skeletal part on the left side of the thorax, comprising the rib cage.',
                'Sixth skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone situated at the forefront of the left side of the chest, serving as '
                'the sixth rib.',
                'The sixth osseous segment on the left side of the thorax, part of the rib cage.',
                'Sixth skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component located on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'The sixth bony unit on the left side of the thoracic cavity, contributing to the '
                'rib cage.',
                'Bone situated at the front of the left side of the chest, serving as the sixth '
                'rib.',
                'Sixth osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Sixth skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the sixth rib.'),
 'rib left 7': ('Seventh bone on the left side of the chest, part of the rib cage structure.',
                'Bone located on the left side of the thorax, serving as the seventh rib.',
                'The seventh skeletal element on the left side of the chest, contributing to the '
                'rib cage.',
                'Rib positioned on the left side of the chest, serving as the seventh rib.',
                'Seventh osseous structure on the left side of the thoracic region, contributing '
                'to the rib cage.',
                'The bony element situated on the left side of the chest, constituting the seventh '
                'rib.',
                'Bone positioned at the front of the left side of the chest, forming part of the '
                'rib cage.',
                'The seventh skeletal part on the left side of the thorax, comprising the rib '
                'cage.',
                'Seventh skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone located at the forefront of the left side of the chest, serving as '
                'the seventh rib.',
                'Seventh osseous segment on the left side of the thorax, part of the rib cage.',
                'Seventh skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component situated on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'Seventh bony unit on the left side of the thoracic cavity, contributing to the '
                'rib cage.',
                'Bone situated at the front of the left side of the chest, serving as the seventh '
                'rib.',
                'Seventh osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Seventh skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the seventh rib.'),
 'rib left 8': ('Eighth bone on the left side of the chest, forming part of the rib cage '
                'structure.',
                'Bone located on the left side of the thorax, serving as the eighth rib.',
                'The eighth skeletal element on the left side of the chest, contributing to the '
                'rib cage.',
                'Rib positioned on the left side of the chest, serving as the eighth rib.',
                'Eighth osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element situated on the left side of the chest, constituting the eighth '
                'rib.',
                'Bone positioned at the front of the left side of the chest, forming part of the '
                'rib cage.',
                'The eighth skeletal part on the left side of the thorax, comprising the rib cage.',
                'Eighth skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone located at the forefront of the left side of the chest, serving as '
                'the eighth rib.',
                'Eighth osseous segment on the left side of the thorax, part of the rib cage.',
                'Eighth skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component situated on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'Eighth bony unit on the left side of the thoracic cavity, contributing to the rib '
                'cage.',
                'Bone situated at the front of the left side of the chest, serving as the eighth '
                'rib.',
                'Eighth osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Eighth skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the eighth rib.'),
 'rib left 9': ('Ninth bone on the left side of the chest, forming part of the rib cage structure.',
                'Bone located on the left side of the thorax, serving as the ninth rib.',
                'The ninth skeletal element on the left side of the chest, contributing to the rib '
                'cage.',
                'Rib positioned on the left side of the chest, serving as the ninth rib.',
                'Ninth osseous structure on the left side of the thoracic region, contributing to '
                'the rib cage.',
                'The bony element situated on the left side of the chest, constituting the ninth '
                'rib.',
                'Bone positioned at the front of the left side of the chest, forming part of the '
                'rib cage.',
                'The ninth skeletal part on the left side of the thorax, comprising the rib cage.',
                'Ninth skeletal unit on the left side of the chest, contributing to the rib cage '
                'structure.',
                'The rib bone located at the forefront of the left side of the chest, serving as '
                'the ninth rib.',
                'Ninth osseous segment on the left side of the thorax, part of the rib cage.',
                'Ninth skeletal element on the left side of the chest, forming part of the rib '
                'cage framework.',
                'The bony component situated on the left side of the chest, constituting the rib '
                'cage.',
                'Bone positioned at the anterior aspect of the left side of the chest, forming '
                'part of the rib cage.',
                'Ninth bony unit on the left side of the thoracic cavity, contributing to the rib '
                'cage.',
                'Bone situated at the front of the left side of the chest, serving as the ninth '
                'rib.',
                'Ninth osseous component on the left side of the chest, forming part of the rib '
                'cage.',
                'The rib located on the left side of the chest, serving as the anterior component '
                'of the rib cage.',
                'Ninth skeletal unit on the left side of the chest, forming part of the rib cage '
                'structure.',
                'The bony segment positioned at the forefront of the left side of the chest, '
                'serving as the ninth rib.'),
 'rib right 1': ('First bone on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the first rib.',
                 'The first skeletal element on the right side of the chest, contributing to the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the first rib.',
                 'First osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the first '
                 'rib.',
                 'Bone positioned at the front of the right side of the chest, forming part of the '
                 'rib cage.',
                 'The first skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'First skeletal unit on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'The rib bone located at the forefront of the right side of the chest, serving as '
                 'the first rib.',
                 'First osseous segment on the right side of the thorax, part of the rib cage.',
                 'First skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the rib '
                 'cage.',
                 'Bone positioned at the anterior aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'First bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the front of the right side of the chest, serving as the first '
                 'rib.',
                 'First osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the anterior '
                 'component of the rib cage.',
                 'First skeletal unit on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'The bony segment positioned at the forefront of the right side of the chest, '
                 'serving as the first rib.'),
 'rib right 10': ('Tenth bone on the right side of the chest, forming part of the rib cage '
                  'structure.',
                  'Bone located on the right side of the thorax, serving as the tenth rib.',
                  'The tenth skeletal element on the right side of the chest, contributing to the '
                  'rib cage.',
                  'Rib positioned on the right side of the chest, serving as the tenth rib.',
                  'Tenth osseous structure on the right side of the thoracic region, contributing '
                  'to the rib cage.',
                  'The bony element situated on the right side of the chest, constituting the '
                  'tenth rib.',
                  'Bone positioned at the right lateral aspect of the chest, forming part of the '
                  'rib cage.',
                  'The tenth skeletal part on the right side of the thorax, comprising the rib '
                  'cage.',
                  'Tenth skeletal unit on the right side of the chest, contributing to the rib '
                  'cage structure.',
                  'The rib bone located at the lateral aspect of the right side of the chest, '
                  'serving as the tenth rib.',
                  'Tenth osseous segment on the right side of the thorax, part of the rib cage.',
                  'Tenth skeletal element on the right side of the chest, forming part of the rib '
                  'cage framework.',
                  'The bony component situated on the right side of the chest, constituting the '
                  'tenth rib.',
                  'Bone positioned at the lateral aspect of the right side of the chest, forming '
                  'part of the rib cage.',
                  'Tenth bony unit on the right side of the thoracic cavity, contributing to the '
                  'rib cage.',
                  'Bone situated at the right lateral aspect of the chest, serving as the tenth '
                  'rib.',
                  'Tenth osseous component on the right side of the chest, forming part of the rib '
                  'cage.',
                  'The rib located on the right side of the chest, serving as the lateral '
                  'component of the rib cage.',
                  'Tenth skeletal unit on the right side of the chest, forming part of the rib '
                  'cage structure.',
                  'The bony segment positioned at the right lateral aspect of the chest, serving '
                  'as the tenth rib.'),
 'rib right 11': ('Eleventh bone on the right side of the chest, forming part of the rib cage '
                  'structure.',
                  'Bone located on the right side of the thorax, serving as the eleventh rib.',
                  'The eleventh skeletal element on the right side of the chest, contributing to '
                  'the rib cage.',
                  'Rib positioned on the right side of the chest, serving as the eleventh rib.',
                  'Eleventh osseous structure on the right side of the thoracic region, '
                  'contributing to the rib cage.',
                  'The bony element situated on the right side of the chest, constituting the '
                  'eleventh rib.',
                  'Bone positioned at the right lateral aspect of the chest, forming part of the '
                  'rib cage.',
                  'The eleventh skeletal part on the right side of the thorax, comprising the rib '
                  'cage.',
                  'Eleventh skeletal unit on the right side of the chest, contributing to the rib '
                  'cage structure.',
                  'The rib bone located at the lateral aspect of the right side of the chest, '
                  'serving as the eleventh rib.',
                  'Eleventh osseous segment on the right side of the thorax, part of the rib cage.',
                  'Eleventh skeletal element on the right side of the chest, forming part of the '
                  'rib cage framework.',
                  'The bony component situated on the right side of the chest, constituting the '
                  'eleventh rib.',
                  'Bone positioned at the lateral aspect of the right side of the chest, forming '
                  'part of the rib cage.',
                  'Eleventh bony unit on the right side of the thoracic cavity, contributing to '
                  'the rib cage.',
                  'Bone situated at the right lateral aspect of the chest, serving as the eleventh '
                  'rib.',
                  'Eleventh osseous component on the right side of the chest, forming part of the '
                  'rib cage.',
                  'The rib located on the right side of the chest, serving as the lateral '
                  'component of the rib cage.',
                  'Eleventh skeletal unit on the right side of the chest, forming part of the rib '
                  'cage structure.',
                  'The bony segment positioned at the right lateral aspect of the chest, serving '
                  'as the eleventh rib.'),
 'rib right 12': ('Twelfth bone on the right side of the chest, forming part of the rib cage '
                  'structure.',
                  'Bone located on the right side of the thorax, serving as the twelfth rib.',
                  'The twelfth skeletal element on the right side of the chest, contributing to '
                  'the rib cage.',
                  'Rib positioned on the right side of the chest, serving as the twelfth rib.',
                  'Twelfth osseous structure on the right side of the thoracic region, '
                  'contributing to the rib cage.',
                  'The bony element situated on the right side of the chest, constituting the '
                  'twelfth rib.',
                  'Bone positioned at the right lateral aspect of the chest, forming part of the '
                  'rib cage.',
                  'The twelfth skeletal part on the right side of the thorax, comprising the rib '
                  'cage.',
                  'Twelfth skeletal unit on the right side of the chest, contributing to the rib '
                  'cage structure.',
                  'The rib bone located at the lateral aspect of the right side of the chest, '
                  'serving as the twelfth rib.',
                  'Twelfth osseous segment on the right side of the thorax, part of the rib cage.',
                  'Twelfth skeletal element on the right side of the chest, forming part of the '
                  'rib cage framework.',
                  'The bony component situated on the right side of the chest, constituting the '
                  'twelfth rib.',
                  'Bone positioned at the lateral aspect of the right side of the chest, forming '
                  'part of the rib cage.',
                  'Twelfth bony unit on the right side of the thoracic cavity, contributing to the '
                  'rib cage.',
                  'Bone situated at the right lateral aspect of the chest, serving as the twelfth '
                  'rib.',
                  'Twelfth osseous component on the right side of the chest, forming part of the '
                  'rib cage.',
                  'The rib located on the right side of the chest, serving as the lateral '
                  'component of the rib cage.',
                  'Twelfth skeletal unit on the right side of the chest, forming part of the rib '
                  'cage structure.',
                  'The bony segment positioned at the right lateral aspect of the chest, serving '
                  'as the twelfth rib.'),
 'rib right 2': ('Second bone on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the second rib.',
                 'The second skeletal element on the right side of the chest, contributing to the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the second rib.',
                 'Second osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the '
                 'second rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The second skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Second skeletal unit on the right side of the chest, contributing to the rib '
                 'cage structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the second rib.',
                 'Second osseous segment on the right side of the thorax, part of the rib cage.',
                 'Second skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'second rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Second bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the second '
                 'rib.',
                 'Second osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Second skeletal unit on the right side of the chest, forming part of the rib '
                 'cage structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the second rib.'),
 'rib right 3': ('Third bone on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the third rib.',
                 'The third skeletal element on the right side of the chest, contributing to the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the third rib.',
                 'Third osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the third '
                 'rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The third skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Third skeletal unit on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the third rib.',
                 'Third osseous segment on the right side of the thorax, part of the rib cage.',
                 'Third skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'third rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Third bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the third '
                 'rib.',
                 'Third osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Third skeletal unit on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the third rib.'),
 'rib right 4': ('Fourth bone on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the fourth rib.',
                 'The fourth skeletal element on the right side of the chest, forming part of the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the fourth rib.',
                 'Fourth osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the '
                 'fourth rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The fourth skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Fourth skeletal unit on the right side of the chest, contributing to the rib '
                 'cage structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the fourth rib.',
                 'Fourth osseous segment on the right side of the thorax, part of the rib cage.',
                 'Fourth skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'fourth rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Fourth bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the fourth '
                 'rib.',
                 'Fourth osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Fourth skeletal unit on the right side of the chest, forming part of the rib '
                 'cage structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the fourth rib.'),
 'rib right 5': ('Fifth bone on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the fifth rib.',
                 'The fifth skeletal element on the right side of the chest, forming part of the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the fifth rib.',
                 'Fifth osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the fifth '
                 'rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The fifth skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Fifth skeletal unit on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the fifth rib.',
                 'Fifth osseous segment on the right side of the thorax, part of the rib cage.',
                 'Fifth skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'fifth rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Fifth bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the fifth '
                 'rib.',
                 'Fifth osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Fifth skeletal unit on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the fifth rib.'),
 'rib right 6': ('The sixth bone on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the sixth rib.',
                 'The sixth skeletal element on the right side of the chest, forming part of the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the sixth rib.',
                 'Sixth osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the sixth '
                 'rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The sixth skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Sixth skeletal unit on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the sixth rib.',
                 'Sixth osseous segment on the right side of the thorax, part of the rib cage.',
                 'Sixth skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'sixth rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Sixth bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the sixth '
                 'rib.',
                 'Sixth osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Sixth skeletal unit on the right side of the chest, forming part of the rib cage '
                 'structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the sixth rib.'),
 'rib right 7': ('The seventh bone on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the seventh rib.',
                 'The seventh skeletal element on the right side of the chest, forming part of the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the seventh rib.',
                 'Seventh osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the '
                 'seventh rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The seventh skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Seventh skeletal unit on the right side of the chest, contributing to the rib '
                 'cage structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the seventh rib.',
                 'Seventh osseous segment on the right side of the thorax, part of the rib cage.',
                 'Seventh skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'seventh rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Seventh bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the seventh '
                 'rib.',
                 'Seventh osseous component on the right side of the chest, forming part of the '
                 'rib cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Seventh skeletal unit on the right side of the chest, forming part of the rib '
                 'cage structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the seventh rib.'),
 'rib right 8': ('The eighth bone on the right side of the chest, contributing to the rib cage '
                 'structure.',
                 'Bone located on the right side of the thorax, serving as the eighth rib.',
                 'The eighth skeletal element on the right side of the chest, forming part of the '
                 'rib cage.',
                 'Rib positioned on the right side of the chest, serving as the eighth rib.',
                 'Eighth osseous structure on the right side of the thoracic region, contributing '
                 'to the rib cage.',
                 'The bony element situated on the right side of the chest, constituting the '
                 'eighth rib.',
                 'Bone positioned at the right lateral aspect of the chest, forming part of the '
                 'rib cage.',
                 'The eighth skeletal part on the right side of the thorax, comprising the rib '
                 'cage.',
                 'Eighth skeletal unit on the right side of the chest, contributing to the rib '
                 'cage structure.',
                 'The rib bone located at the lateral aspect of the right side of the chest, '
                 'serving as the eighth rib.',
                 'Eighth osseous segment on the right side of the thorax, part of the rib cage.',
                 'Eighth skeletal element on the right side of the chest, forming part of the rib '
                 'cage framework.',
                 'The bony component situated on the right side of the chest, constituting the '
                 'eighth rib.',
                 'Bone positioned at the lateral aspect of the right side of the chest, forming '
                 'part of the rib cage.',
                 'Eighth bony unit on the right side of the thoracic cavity, contributing to the '
                 'rib cage.',
                 'Bone situated at the right lateral aspect of the chest, serving as the eighth '
                 'rib.',
                 'Eighth osseous component on the right side of the chest, forming part of the rib '
                 'cage.',
                 'The rib located on the right side of the chest, serving as the lateral component '
                 'of the rib cage.',
                 'Eighth skeletal unit on the right side of the chest, forming part of the rib '
                 'cage structure.',
                 'The bony segment positioned at the right lateral aspect of the chest, serving as '
                 'the eighth rib.'),
 'rib right 9': ('Rib right 9: The ninth rib on the right side of the chest.',
                 "Ninth rib's attachment point with the thoracic vertebrae on the right-hand side.",
                 'The ninth numbered rib in the sequence from the midline to the right edge of the '
                 'ribcage.',
                 'In human anatomy, it denotes the position of the ninth rib on the right side '
                 'relative to the vertebral column.',
                 'Anatomical reference to the ninth rib on the right, which forms part of the '
                 'protective cage for the lungs.',
                 'Describes the skeletal structure at the right lateral aspect of the ribcage, '
                 'corresponding to the ninth rib.',
                 'A bony landmark on the right side of the chest wall marking the ninth rib '
                 'location.',
                 'A thoracic skeletal element on the right, numbered nine in the series of twelve '
                 'pairs of ribs.',
                 'The connection between the ninth rib and its corresponding costal cartilage on '
                 'the right side.',
                 'The site where the ninth rib articulates with the dorsal vertebrae, specifically '
                 'on the right.',
                 'In mammalian anatomy, identifies the ninth rib in the right half of the ribcage.',
                 'Refers to the structural component aiding respiratory function by expanding and '
                 'contracting on the right side, counted as the ninth rib.',
                 'The numbered identification of the rib that lies beneath the right shoulder '
                 'blade, being the ninth in succession.',
                 'A reference to the anatomical location where the ninth rib meets the sternum via '
                 'the costal groove on the right.',
                 'The specific point of connection between the thoracic spine and the ribcage on '
                 'the right side, pertaining to the ninth rib.',
                 'One of the bilateral structures forming the protective enclosure around the '
                 'thoracic organs, particularly on the right side as the ninth rib.',
                 'In a biological context, signifies the segmentation of the right thoracic cavity '
                 "defined by the ninth rib's placement."),
 'sacrum': ('The triangular bone located at the base of the spine, below the lumbar vertebrae and '
            'above the coccyx.',
            'A large, triangular bone situated at the base of the spine, formed by the fusion of '
            'five vertebrae.',
            ...
            'A triangular bone located between the lumbar vertebrae and the coccyx, forming part '
            'of the pelvis.',
            'The fused vertebrae located at the base of the spinal column, connecting to the '
            'pelvic bones.',
            'A large triangular bone formed by the fusion of five sacral vertebrae, situated at '
            'the base of the spine.',
            'The bone at the lower end of the vertebral column, forming part of the pelvis.',
            'The set of fused vertebrae at the base of the spine, connecting the vertebral column '
            'to the pelvis.',
            'A triangular-shaped bone situated between the lumbar vertebrae and the coccyx.',
            'The bone formed by the fusion of five sacral vertebrae, located at the base of the '
            'vertebral column.',
            'The bone that connects the vertebral column to the pelvic bones, formed by the fusion '
            'of five sacral vertebrae.',
            'A large, triangular bone at the base of the spinal column, connecting to the pelvic '
            'girdle.',
            'The segment of the vertebral column that forms the back part of the pelvis.',
            'The triangular bone formed by the fusion of sacral vertebrae, located at the base of '
            'the spine.',
            'A bone formed by the fusion of several vertebrae, situated between the lumbar spine '
            'and the coccyx.',
            ...
            'A triangular-shaped bone located between the lumbar vertebrae and the coccyx, forming '
            'part of the pelvis.'),
 'scapula left': ('The flat, triangular bone on the left side of the upper back, forming part of '
                  'the shoulder.',
                  'The bone situated on the left side of the upper back, forming the back part of '
                  'the shoulder.',
                  'A flat, triangular bone located on the left side of the upper back, forming the '
                  'shoulder joint.',
                  'The triangular-shaped bone positioned on the left side of the upper back, '
                  'contributing to the shoulder.',
                  'A bone located on the left side of the upper back, connecting the humerus and '
                  'the clavicle.',
                  'The left-sided bone in the upper back, articulating with the humerus and the '
                  'clavicle.',
                  'A triangular bone on the left side of the upper back, connecting the arm to the '
                  'trunk.',
                  'The bone on the left side of the upper back, forming the shoulder blade.',
                  'A flat bone on the left side of the upper back, providing attachment for '
                  'muscles and ligaments.',
                  'The bone located on the left side of the upper back, involved in shoulder '
                  'movement.',
                  'The left-sided shoulder blade, a flat triangular bone on the upper back.',
                  'A bone situated on the left side of the upper back, contributing to the '
                  'shoulder joint.',
                  ...
                  'A bone positioned on the left side of the upper back, forming part of the '
                  'shoulder girdle.',
                  'The left scapula, a flat bone providing attachment for shoulder muscles.',
                  'A triangular-shaped bone located on the left side of the upper back, '
                  'articulating with the humerus.',
                  'The left scapula, a flat bone connecting the upper arm to the trunk.',
                  'A bone on the left side of the upper back, forming the back part of the '
                  'shoulder joint.'),
 'scapula right': ('The flat, triangular bone on the right side of the upper back, forming part of '
                   'the shoulder.',
                   'The bone situated on the right side of the upper back, forming the back part '
                   'of the shoulder.',
                   'A flat, triangular bone located on the right side of the upper back, forming '
                   'the shoulder joint.',
                   'The triangular-shaped bone positioned on the right side of the upper back, '
                   'contributing to the shoulder.',
                   'A bone located on the right side of the upper back, connecting the humerus and '
                   'the clavicle.',
                   'The right-sided bone in the upper back, articulating with the humerus and the '
                   'clavicle.',
                   'A triangular bone on the right side of the upper back, connecting the arm to '
                   'the trunk.',
                   'The bone on the right side of the upper back, forming the shoulder blade.',
                   'A flat bone on the right side of the upper back, providing attachment for '
                   'muscles and ligaments.',
                   'The bone located on the right side of the upper back, involved in shoulder '
                   'movement.',
                   'The right-sided shoulder blade, a flat triangular bone on the upper back.',
                   'A bone situated on the right side of the upper back, contributing to the '
                   'shoulder joint.',
                   ...
                   'A bone positioned on the right side of the upper back, forming part of the '
                   'shoulder girdle.',
                   'The right scapula, a flat bone providing attachment for shoulder muscles.',
                   'A triangular-shaped bone located on the right side of the upper back, '
                   'articulating with the humerus.',
                   'The right scapula, a flat bone connecting the upper arm to the trunk.',
                   'A bone on the right side of the upper back, forming the back part of the '
                   'shoulder joint.'),
 'small bowel': ('The part of the digestive system following the stomach, where most of the '
                 'nutrient absorption occurs.',
                 'The portion of the gastrointestinal tract between the stomach and the large '
                 'intestine.',
                 'The section of the alimentary canal responsible for further digestion and '
                 'nutrient absorption.',
                 'The part of the digestive tract where the majority of nutrient absorption takes '
                 'place.',
                 'The segment of the gastrointestinal system involved in the absorption of '
                 'nutrients.',
                 'The part of the alimentary canal where the bulk of nutrient absorption occurs.',
                 'The gastrointestinal segment responsible for absorbing nutrients into the '
                 'bloodstream.',
                 'The portion of the digestive system where the absorption of nutrients primarily '
                 'occurs.',
                 ...
                 'The part of the digestive system where the breakdown of food continues and '
                 'absorption begins.',
                 'The portion of the gastrointestinal system where most of the digestion and '
                 'absorption take place.',
                 'The segment of the digestive tract where food particles are further broken down '
                 'and absorbed.',
                 'The part of the alimentary canal comprising the small intestine.',
                 'The portion of the gastrointestinal system where nutrients are absorbed into the '
                 'bloodstream.',
                 'The part of the digestive system where the small intestine is located.',
                 'The segment of the gastrointestinal tract where nutrient absorption '
                 'predominantly occurs.',
                 'The portion of the alimentary canal where the small intestine is anatomically '
                 'positioned.',
                 'The section of the gastrointestinal system where nutrients are absorbed into the '
                 'body.',
                 'The part of the digestive tract comprising the duodenum, jejunum, and ileum.'),
 'trachea': ('The airway in the respiratory system that connects the larynx to the bronchi, '
             'allowing airflow to and from the lungs.',
             'The windpipe, a tubular structure in the throat that carries air to and from the '
             'lungs for respiration.',
             'A cartilaginous tube extending from the larynx to the bronchi, providing passage for '
             'air to the lungs.',
             'A rigid, tubular structure composed of cartilage rings and lined with mucous '
             'membrane, conducting air to the lungs.',
             'The part of the respiratory tract that conducts air to and from the lungs, commonly '
             'known as the windpipe.',
             'The anatomical structure responsible for air passage between the larynx and the '
             'bronchi in the respiratory system.',
             'A cylindrical, cartilaginous tube that conveys air between the larynx and the '
             'bronchi in the respiratory system.',
             'The passage in the throat through which air passes to and from the lungs, '
             'facilitating breathing and respiration.',
             'The tubular structure connecting the throat to the bronchial tubes, allowing air to '
             'flow to and from the lungs.',
             'A flexible tube supported by C-shaped cartilaginous rings, facilitating the passage '
             'of air into the lungs.',
             'The conduit in the respiratory system that carries air between the larynx and the '
             'bronchi, enabling breathing.',
             'A membranous tube reinforced with cartilage rings, providing a passage for air '
             'between the larynx and lungs.',
             'The tubular organ responsible for the passage of air to and from the lungs in the '
             'respiratory system.',
             'A cylindrical structure composed of cartilage rings, conducting air between the '
             'larynx and the bronchi.',
             'A fibrous tube in the respiratory system, conveying air between the larynx and the '
             'bronchi in the lungs.',
             'The cylindrical airway extending from the larynx to the bronchi, facilitating the '
             'exchange of air in the lungs.',
             'A flexible tube composed of cartilage rings and smooth muscle, allowing airflow to '
             'and from the lungs.',
             'The passage in the respiratory system connecting the throat to the bronchial tubes '
             'for air exchange.',
             'The tubular structure that carries air to and from the lungs, consisting of '
             'cartilaginous rings and smooth muscle.',
             'The anatomical conduit responsible for the transport of air between the larynx and '
             'the bronchi in the respiratory system.'),
 'urinary bladder': ('A hollow organ in the pelvis that stores urine before it is expelled from '
                     'the body.',
                     'An expandable muscular sac located in the pelvis, storing urine produced by '
                     'the kidneys.',
                     'A reservoir for urine storage within the pelvis, releasing urine during '
                     'urination.',
                     'A membranous sac situated in the pelvic cavity, collecting and retaining '
                     'urine until it is voided.',
                     'A muscular sac in the lower abdomen that collects and stores urine before '
                     'excretion.',
                     'An organ in the urinary system that stores urine produced by the kidneys '
                     'before elimination.',
                     'The organ responsible for storing urine prior to its elimination from the '
                     'body.',
                     'A distensible muscular organ in the pelvic cavity, holding urine until it is '
                     'discharged from the body.',
                     'A hollow, muscular organ that collects and stores urine until it is expelled '
                     'from the body.',
                     'The reservoir in the urinary system where urine is stored before being '
                     'voided.',
                     'A sac-like organ located in the pelvis that temporarily stores urine.',
                     'An expandable pouch in the pelvis that stores urine until it is eliminated '
                     'from the body.',
                     'The organ that temporarily holds urine until it is released from the body '
                     'during urination.',
                     'A flexible muscular organ that collects and stores urine until it is '
                     'discharged from the body.',
                     'The organ responsible for storing urine until it is released from the body.',
                     'A sac-like structure in the lower abdomen that stores urine until it is '
                     'excreted.',
                     ...
                     'An elastic muscular sac that holds urine until it is eliminated from the '
                     'body.',
                     'The membranous sac that collects and stores urine prior to urination.'),
 'vertebrae C1': ('The first cervical vertebra in the spine, also known as the atlas.',
                  'The initial bone in the cervical spine, responsible for supporting the skull.',
                  'The topmost vertebra in the neck region, supporting the skull and enabling head '
                  'movement.',
                  'The first cervical bone, located at the base of the skull and allowing nodding '
                  'movements.',
                  ...
                  'The topmost bone in the vertebral column, supporting the head and facilitating '
                  'its movement.',
                  'The first bone of the cervical spine, connecting the skull to the spinal '
                  'column.',
                  'The initial vertebra in the neck, supporting the head and enabling its '
                  'movements.',
                  ...
                  'The initial cervical vertebra, articulating with the skull and supporting head '
                  'movement.',
                  'The first bone of the neck, supporting the weight of the skull.',
                  'The first vertebra of the cervical spine, allowing for the nodding motion of '
                  'the head.',
 ...
 'vertebrae C2': ('The second cervical vertebra in the spine, also known as the axis.',
                  'The second bone in the cervical spine, serving as the pivot for head rotation.',
                  'The bone located just below the atlas, allowing rotational movement of the '
                  'head.',
 ...
 'vertebrae C3': ('The third cervical vertebra in the spine, located below C2.',
 ...
 'vertebrae C4': ('The fourth cervical vertebra in the spine, located below C3.',
 ...
 'vertebrae C5': ('The fifth cervical vertebra in the spine, positioned below C4.',
 ...
 'vertebrae C6': ('The sixth cervical vertebra in the spine, positioned below C5.',
 ...
 'vertebrae C7': ('The seventh cervical vertebra in the spine, positioned below C6.',
 ...
 'vertebrae L1': ('The first lumbar vertebra in the spine, situated above L2.',
                  ...
                  'The first bone of the lumbar spine, located beneath the twelfth thoracic '
                  'vertebra.',
 ...
 'vertebrae L2': ('The second lumbar vertebra in the spine, situated above L3.',
 ...
 'vertebrae L3': ('The third lumbar vertebra in the spine, positioned above L4.',
 ...
 'vertebrae L4': ('The fourth lumbar vertebra in the spine, positioned above L5.',
 ...
 'vertebrae L5': ('The fifth lumbar vertebra in the spine, positioned above the sacrum.',
 ...
 'vertebrae T1': ('The first thoracic vertebra in the spine, located between the cervical and '
                  'thoracic regions.',
                  'The initial bone in the thoracic spine, positioned above T2 vertebra.',
                  'The vertebra at the start of the thoracic spine, following the last cervical '
                  'vertebra.',
                  ...
                  'The bone in the spine, marking the transition from cervical to thoracic '
                  'regions.',
                  'The first bone of the thoracic spine, positioned below the last cervical bone.',
                  'The vertebra following the final cervical vertebra, forming the thoracic '
                  'region.',
                  ...
                  'The bone marking the start of the thoracic spine, below the last cervical '
                  'vertebra.',
 ...
 'vertebrae T10': ('The tenth thoracic vertebra in the spine, located between T9 and T11 '
                   'vertebrae.',
                   'The vertebra positioned in the middle of the thoracic spine, above T11 and '
                   'below T9.',
                   ...
                   'The vertebra positioned centrally in the thoracic spine, following T9 and '
                   'preceding T11.',
                   'The bone in the upper back, located between T9 and T11 vertebrae.',
                   'The thoracic vertebra at the midpoint of the thoracic spine, following T9 and '
                   'preceding T11.',
                   'The vertebra situated in the middle of the thoracic region, above T9 and below '
                   'T11.',
                   ...
                   'The vertebra situated centrally in the thoracic spine, following T9 and '
                   'preceding T11.',
                   ...
                   'The bone in the spine, positioned between T9 and T11 vertebrae.',
                   'The tenth bone of the thoracic spine, located centrally between T9 and T11.'),
 'vertebrae T11': ('The eleventh thoracic vertebra in the spine, situated between T10 and T12 '
                   'vertebrae.',
                   ...
                   'The vertebra positioned centrally in the thoracic spine, following T10 and '
                   'preceding T12.',
                   ...
                   'The vertebra situated in the middle of the thoracic region, above T10 and '
                   'below T12.',
                   'The bone in the spine, marking the center of the thoracic region, between T10 '
                   'and T12 vertebrae.',
                   'The eleventh bone of the thoracic spine, positioned centrally between T10 and '
                   'T12.',
                   ...
                   'The vertebra situated centrally in the thoracic spine, following T10 and '
                   'preceding T12.',
                   'The bone in the upper back, positioned centrally between T10 and T12 '
                   'vertebrae.',
                   'The thoracic vertebra at the midpoint between T10 and T12, in the spine.',
                   ...
                   'The eleventh bone of the thoracic spine, positioned centrally between T10 and '
                   'T12.'),
 'vertebrae T12': ('The twelfth thoracic vertebra in the spine, situated between T11 and L1 '
                   'vertebrae.',
                   ...
                   'The vertebra positioned at the end of the thoracic spine, following T11 and '
                   'preceding L1.',
                   ...
                   'The bone in the spine, marking the endpoint of the thoracic region, between '
                   'T11 and L1 vertebrae.',
                   'The twelfth bone of the thoracic spine, positioned at the lower end of the '
                   'thoracic region.',
                   'The vertebra in the upper back, following T11 and preceding L1 vertebrae.',
                   'The bone in the spine, located at the lower end of the thoracic region, '
                   'between T11 and L1 vertebrae.',
                   'The vertebra situated at the bottom of the thoracic spine, following T11 and '
                   'preceding L1.',
                   'The bone in the upper back, positioned at the bottom of the thoracic region, '
                   'between T11 and L1 vertebrae.',
                   ...
                   'The twelfth bone of the thoracic spine, positioned at the lower end of the '
                   'thoracic region.'),
 'vertebrae T2': ('The second thoracic vertebra in the spine, situated between T1 and T3 '
                  'vertebrae.',
                  ...
                  'The vertebra positioned at the start of the thoracic spine, following T1 and '
                  'preceding T3.',
                  ...
                  'The bone in the spine, marking the beginning of the thoracic region, between T1 '
                  'and T3 vertebrae.',
                  'The second bone of the thoracic spine, positioned at the start of the thoracic '
                  'region.',
                  'The vertebra in the upper back, following T1 and preceding T3 vertebrae.',
                  'The bone in the spine, located at the beginning of the thoracic region, between '
                  'T1 and T3 vertebrae.',
                  'The vertebra situated at the start of the thoracic spine, following T1 and '
                  'preceding T3.',
                  'The bone in the upper back, positioned at the beginning of the thoracic region, '
                  'between T1 and T3 vertebrae.',
                  ...
                  'The second bone of the thoracic spine, positioned at the start of the thoracic '
                  'region.'),
 'vertebrae T3': ('The third thoracic vertebra in the spine, situated between T2 and T4 vertebrae.',
                  ...
                  'The third thoracic vertebra in the spine, positioned between T2 and T4 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T2 and preceding T4 vertebrae.'),
 'vertebrae T4': ('The fourth thoracic vertebra in the spine, situated between T3 and T5 '
                  'vertebrae.',
                  ...
                  'The fourth thoracic vertebra in the spine, positioned between T3 and T5 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T3 and preceding T5 vertebrae.'),
 'vertebrae T5': ('The fifth thoracic vertebra in the spine, situated between T4 and T6 vertebrae.',
                  ...
                  'The fifth thoracic vertebra in the spine, positioned between T4 and T6 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T4 and preceding T6 vertebrae.'),
 'vertebrae T6': ('The sixth thoracic vertebra in the spine, situated between T5 and T7 vertebrae.',
                  ...
                  'The sixth thoracic vertebra in the spine, positioned between T5 and T7 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T5 and preceding T7 vertebrae.'),
 'vertebrae T7': ('The seventh thoracic vertebra in the spine, situated between T6 and T8 '
                  'vertebrae.',
                  ...
                  'The seventh thoracic vertebra in the spine, positioned between T6 and T8 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T6 and preceding T8 vertebrae.'),
 'vertebrae T8': ('The eighth thoracic vertebra in the spine, situated between T7 and T9 '
                  'vertebrae.',
                  ...
                  'The eighth thoracic vertebra in the spine, positioned between T7 and T9 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T7 and preceding T9 vertebrae.'),
 'vertebrae T9': ('The ninth thoracic vertebra in the spine, situated between T8 and T10 '
                  'vertebrae.',
                  ...
                  'The ninth thoracic vertebra in the spine, positioned between T8 and T10 '
                  'vertebrae.',
                  ...
                  'The bone in the thoracic region, following T8 and preceding T10 vertebrae.'),
 'cervical spine C1': ('The first vertebra in the cervical spine, also known as the atlas.',
                       'The topmost bone in the neck region of the spine, responsible for '
                       'supporting the head.',
                       ...
                       'The vertebra located at the top of the cervical spine, forming the joint '
                       'with the skull.',
                       'The bone at the beginning of the neck, serving as the connection between '
                       'the skull and spine.',
                       ...
                       'The cervical vertebra immediately below the skull, responsible for head '
                       'movement.',
                       ...
                       'The bone connecting the skull to the cervical spine, facilitating head '
                       'movement.',
                       'The initial vertebra of the neck, responsible for articulating with the '
                       'skull.',
                       'The upper cervical vertebra, playing a crucial role in head movement and '
                       'stability.',
                       ...
                       'The vertebra at the base of the skull, forming the joint with the cervical '
                       'spine.',
                       'The first cervical vertebra, supporting the weight of the head and '
                       'facilitating movement.'),
 'cervical spine C2': ('The second vertebra in the cervical spine, also known as the axis.',
                       ...
                       'The second bone of the cervical spine, crucial for rotational movement of '
                       'the head.',
                       ...
                       'The bone located after C1, responsible for rotational movements of the '
                       'neck.',
                       ...
                       'The second bone in the cervical spine, allowing for rotational movement of '
                       'the head.',
                       ...
                       'The second cervical vertebra, allowing for rotational movements of the '
                       'head.',
                       'The bone immediately following the atlas, facilitating head rotation.',
                       'The cervical vertebra located after C1, enabling rotational movement of '
                       'the head.'),
 'cervical spine C3': ('The third vertebra in the cervical spine, located below C2.',
 ...
 'cervical spine C4': ('The fourth vertebra in the cervical spine, located below C3.',
 ...
 'cervical spine C5': ('The fifth vertebra in the cervical spine, located below C4.',
 ...
 'cervical spine C6': ('The sixth vertebra in the cervical spine, located below C5.',
 ...
 'cervical spine C7': ('The seventh vertebra in the cervical spine, located below C6.',
 ...
 'thoracic spine T1': ('The first vertebra in the thoracic spine, located above C7.',
 ...
 'thoracic spine T2': ('The second vertebra in the thoracic spine, located below T1.',
 ...
 'thoracic spine T3': ('The third vertebra in the thoracic spine, positioned below T2.',
 ...
 'thoracic spine T4': ('The fourth vertebra in the thoracic spine, positioned below T3.',
 ...
 'thoracic spine T5': ('The fifth vertebra in the thoracic spine, positioned below T4.',
 ...
 'thoracic spine T6': ('The sixth vertebra in the thoracic spine, positioned below T5.',
 ...
 'thoracic spine T7': ('The seventh vertebra in the thoracic spine, positioned below T6.',
 ...
 'thoracic spine T8': ('The eighth vertebra in the thoracic spine, positioned below T7.',
 ...
 'thoracic spine T9': ('The ninth vertebra in the thoracic spine, positioned below T8.',
 ...
 'thoracic spine T10': ('The tenth vertebra in the thoracic spine, positioned below T9.',
 ...
 'thoracic spine T11': ('The eleventh vertebra in the thoracic spine, positioned below T10.',
 ...
 'thoracic spine T12': ('The twelfth vertebra in the thoracic spine, positioned at the bottom of '
                        'the thoracic region.',
                        ...
                        'The last bone in the thoracic spine before transitioning to the lumbar '
                        'region.',
                        'The vertebra following T11 and marking the end of the thoracic spine.',
                        'The bone at the base of the thoracic spine before transitioning to the '
                        'lumbar region.',
                        'The twelfth bone in the sequence of thoracic vertebrae.',
                        'The bone positioned below T11 and marking the end of the thoracic spine '
                        'series.',
 ...
 'lumbar spine L1': ('The first vertebra in the lumbar spine, situated at the top of the lumbar '
                     'region.',
 ...
 'lumbar spine L2': ('The second vertebra in the lumbar spine, situated below L1.',
                     ...
                     'The bone following L1 and preceding L3 in the lumbar spine, identified as '
                     'L2.',
                     'The next bone in the lumbar spine sequence after L1, designated as L2.',
                     'The bone immediately succeeding L1 and preceding L3 in the lumbar spine '
                     'series.',
                     ...
                     'The bone positioned below L1 and above L3 in the lumbar spine, designated as '
                     'L2.'),
 'lumbar spine L3': ('The third vertebra in the lumbar spine, situated below L2.',
                     ...
                     'The bone following L2 and preceding L4 in the lumbar spine, identified as '
                     'L3.',
                     'The next bone in the lumbar spine sequence after L2, designated as L3.',
                     'The bone immediately succeeding L2 and preceding L4 in the lumbar spine '
                     'series.',
                     ...
                     'The bone positioned below L2 and above L4 in the lumbar spine, designated as '
                     'L3.'),
 'lumbar spine L4': ('The fourth vertebra in the lumbar spine, situated below L3.',
                     ...
                     'The bone following L3 and preceding L5 in the lumbar spine, identified as '
                     'L4.',
                     'The next bone in the lumbar spine sequence after L3, designated as L4.',
                     'The bone immediately succeeding L3 and preceding L5 in the lumbar spine '
                     'series.',
                     ...
                     'The bone positioned below L3 and above L5 in the lumbar spine, designated as '
                     'L4.'),
 'lumbar spine L5': ('The fifth vertebra in the lumbar spine, situated below L4.',
                     ...
                     'The bone following L4 and preceding the sacrum in the lumbar spine, '
                     'identified as L5.',
                     'The next bone in the lumbar spine sequence after L4, designated as L5.',
                     'The bone immediately succeeding L4 and preceding the sacrum in the lumbar '
                     'spine series.',
                     'The vertebra below L4 and above the sacrum in the lumbar spine, denoted as '
                     'L5.',
                     'The fifth vertebra in the lumbar spine sequence, located below L4.',
                     'The bone positioned below L4 and above the sacrum in the lumbar spine, '
                     'designated as L5.'),
 'lumbar spine L6': ('A hypothetical additional vertebra beyond the standard lumbar spine '
                     'sequence.',
                     'An imaginary sixth vertebra in the lumbar spine, not typically present in '
                     'humans.',
                     ...
                     'A conceptualization of a sixth lumbar vertebra, beyond the common L5 '
                     'vertebra.',
                     'A theoretical concept suggesting a vertebra beyond the standard lumbar spine '
                     'sequence.',
                     'An extrapolation of the lumbar spine sequence to include a sixth vertebra.',
                     'A notional extension of the lumbar spine series beyond the fifth vertebra, '
                     'L5.',
                     ...
                     'A conjectural continuation of the lumbar spine sequence with an additional '
                     'vertebra.',
                     'An imaginary vertebra imagined to exist beyond the usual lumbar spine '
                     'series.',
                     'A conceptual extension of the lumbar spine sequence to include an extra '
                     'vertebra.',
                     'A speculative notion of a vertebra beyond the standard lumbar spine '
                     'configuration.',
                     'A theoretical construct representing a potential sixth vertebra in the '
                     'lumbar spine.',
                     'An abstract concept proposing an additional lumbar vertebra beyond L5.',
                     'A theoretical construct of an extra vertebra beyond the usual lumbar spine '
                     'arrangement.',
                     'A conceptualization of a potential sixth lumbar vertebra in the spine.',
                     'An extrapolation of the lumbar spine series to include a fictitious L6 '
                     'vertebra.',
                     'A theoretical proposition of an additional lumbar vertebra beyond the common '
                     'L5.'),
 'coccygis': ('The terminal segment of the vertebral column, often referred to as the tailbone.',
              'The small triangular bone at the base of the vertebral column, forming the '
              'tailbone.',
              'The final segment of the vertebral column, comprised of fused coccygeal vertebrae.',
              'The bony structure located at the bottom of the spine, consisting of fused '
              'vertebrae.',
              'The skeletal element situated at the lower end of the vertebral column, forming the '
              'tailbone.',
              'The anatomical structure composed of fused coccygeal vertebrae, located at the base '
              'of the spine.',
              'The terminal portion of the spinal column, comprised of fused coccygeal vertebrae.',
              'The small bone at the base of the spine, formed by the fusion of coccygeal '
              'vertebrae.',
              'The final segment of the vertebral column, also known as the tailbone or coccyx.',
              'The bone located at the end of the spinal column, consisting of fused coccygeal '
              'vertebrae.',
              'The skeletal structure situated at the base of the spine, formed by the fusion of '
              'vertebrae.',
              'The bony structure at the lower end of the vertebral column, composed of fused '
              'vertebrae.',
              'The anatomical feature at the base of the spine, formed by the fusion of coccygeal '
              'vertebrae.',
              'The terminal part of the vertebral column, comprising the coccygeal vertebrae.',
              'The bone located at the bottom of the spine, formed by the fusion of coccygeal '
              'vertebrae.',
              'The skeletal component at the end of the vertebral column, also called the '
              'tailbone.',
              'The small bone structure formed by the fusion of coccygeal vertebrae, at the base '
              'of the spine.',
              'The anatomical entity comprising fused coccygeal vertebrae, forming the tailbone.',
              'The terminal skeletal element of the spine, consisting of fused coccygeal '
              'vertebrae.',
              'The bony structure located at the base of the spine, formed by the fusion of '
              'vertebrae.'),
 'additional 13th thoracic vertebra, T13': ('An extra vertebra occurring beyond the usual 12 '
                                            'thoracic vertebrae, labeled as T13.',
                                            'An additional thoracic vertebra present after the '
                                            'typical 12 thoracic vertebrae, designated as T13.',
                                            'A supernumerary vertebra situated beyond the regular '
                                            'thoracic vertebrae, identified as T13.',
                                            'An extra thoracic vertebra found following the '
                                            'standard sequence of 12 thoracic vertebrae, denoted '
                                            'as T13.',
                                            'A surplus vertebral segment located beyond the '
                                            'customary 12 thoracic vertebrae, annotated as T13.',
                                            'An additional vertebral unit occurring after the '
                                            'normal thoracic vertebrae, marked as T13.',
                                            'A supplementary thoracic vertebra positioned beyond '
                                            'the standard 12 thoracic vertebrae, labeled as T13.',
                                            'An excess vertebra situated beyond the typical '
                                            'thoracic sequence, identified as T13.',
                                            'A supernumerary vertebral component found after the '
                                            'usual 12 thoracic vertebrae, designated as T13.',
                                            'An extra thoracic vertebral element occurring after '
                                            'the regular 12 thoracic vertebrae, referred to as '
                                            'T13.',
                                            'A surplus skeletal structure located beyond the '
                                            'standard thoracic vertebrae, annotated as T13.',
                                            'An additional thoracic segment present beyond the '
                                            'typical sequence of 12 vertebrae, denoted as T13.',
                                            'A supernumerary skeletal unit situated after the '
                                            'customary 12 thoracic vertebrae, marked as T13.',
                                            'An excess vertebral unit occurring after the usual 12 '
                                            'thoracic vertebrae, labeled as T13.',
                                            'A supplementary thoracic skeletal component '
                                            'positioned beyond the standard sequence, identified '
                                            'as T13.',
                                            'An additional vertebral entity found after the '
                                            'regular thoracic sequence, designated as T13.',
                                            'An extra segment of the thoracic spine present beyond '
                                            'the typical 12 vertebrae, denoted as T13.',
                                            'A supernumerary thoracic vertebra located after the '
                                            'usual 12 vertebrae, annotated as T13.',
                                            'An excess thoracic vertebral component occurring '
                                            'beyond the standard sequence, marked as T13.',
                                            'A supplementary skeletal structure positioned after '
                                            'the customary 12 thoracic vertebrae, labeled as T13.'),
 'additional 13th thoracic vertebra T13': ('An extra vertebra occurring beyond the usual 12 '
                                           'thoracic vertebrae, labeled as T13.',
                                           'An additional thoracic vertebra present after the '
                                           'typical 12 thoracic vertebrae, designated as T13.',
                                           ...
                                           'thoracic vertebrae, identified as T13.',
                                           'An extra thoracic vertebra found following the '
                                           'standard sequence of 12 thoracic vertebrae, denoted as '
                                           'T13.',
                                           'A surplus vertebral segment located beyond the '
                                           'customary 12 thoracic vertebrae, annotated as T13.',
                                           'An additional vertebral unit occurring after the '
                                           ...
                                           'usual 12 thoracic vertebrae, designated as T13.',
                                           'An extra thoracic vertebral element occurring after '
                                           'the regular 12 thoracic vertebrae, referred to as T13.',
                                           'A surplus skeletal structure located beyond the '
                                           'standard thoracic vertebrae, annotated as T13.',
                                           'An additional thoracic segment present beyond the '
                                           'typical sequence of 12 vertebrae, denoted as T13.',
                                           ...
                                           'An excess vertebral unit occurring after the usual 12 '
                                           'thoracic vertebrae, labeled as T13.',
                                           'A supplementary thoracic skeletal component positioned '
                                           'beyond the standard sequence, identified as T13.',
                                           'An additional vertebral entity found after the regular '
                                           'thoracic sequence, designated as T13.',
                                           'An extra segment of the thoracic spine present beyond '
                                           'the typical 12 vertebrae, denoted as T13.',
                                           'A supernumerary thoracic vertebra located after the '
                                           'usual 12 vertebrae, annotated as T13.',
                                           ...
                                           'A supplementary skeletal structure positioned after '
                                           'the customary 12 thoracic vertebrae, labeled as T13.'),
 'pancreatic lesion': ('Abnormality or anomaly occurring in the pancreas, often indicative of '
                       'disease.',
                       'An irregularity or anomaly found within the pancreatic tissue, typically '
                       'indicating pathology.',
                       'A deviation or anomaly observed in the pancreas, often suggesting '
                       'pathological changes.',
                       'An abnormality or irregularity detected in the pancreatic structure, '
                       'usually associated with disease.',
                       'Anomaly or abnormality present in the pancreas, commonly indicative of '
                       'pathological conditions.',
                       'Deviation or anomaly within the pancreatic tissue, often indicating '
                       'pathological processes.',
                       'Abnormality or irregularity in the pancreas, typically signaling '
                       'underlying pathological changes.',
                       'Anomaly or deviation found in the pancreatic structure, often suggestive '
                       'of pathological conditions.',
                       'Abnormality or irregularity observed in the pancreas, usually indicative '
                       'of pathological processes.',
                       'Anomaly or deviation detected within the pancreatic tissue, often '
                       'associated with pathological changes.',
                       'Abnormality or anomaly present in the pancreas, typically reflecting '
                       'pathological conditions.',
                       'Anomaly or irregularity identified in the pancreatic structure, often '
                       'indicating pathological processes.',
                       'Abnormality or anomaly occurring in the pancreas, commonly associated with '
                       'pathological changes.',
                       'Irregularity or deviation found within the pancreatic tissue, often '
                       'suggestive of pathology.',
                       'Anomaly or abnormality observed in the pancreas, often indicating '
                       'underlying pathological processes.',
                       'Deviation or irregularity detected in the pancreatic structure, typically '
                       'associated with pathology.',
                       'Anomaly or abnormality present in the pancreas, often indicative of '
                       'underlying pathological conditions.',
                       'Irregularity or anomaly occurring in the pancreas, commonly associated '
                       'with pathological changes.',
                       'Deviation or anomaly observed within the pancreatic tissue, often '
                       'suggestive of pathology.',
                       'Anomaly or irregularity found in the pancreas, typically indicating '
                       'pathological processes.'),
 'colon cancer': ('Malignant growth or tumor occurring in the colon.',
 ...
 'hepatic vessels': ('Blood vessels that supply or drain the liver.',
 ...
 'tumour': ('Abnormal mass of tissue that can be benign or malignant.',
 ...
 'lung tumours': ('Abnormal growths in the lung tissue.',
 ...
 'intestine': ('A tubular organ of the digestive system.',
 ...
 'adrenal': ('An endocrine gland located above the kidney.',
 ...
 'head of femur left': ('The uppermost part of the thigh bone on the left side.',
 ...
 'head of femur right': ('The ball-shaped bone structure at the top of the right thigh bone.',
                         ...
                         'The anatomical feature where the right leg connects to the pelvic '
                         'girdle.',
                         ...
                         'The segment of the right femur that inserts into the socket of the '
                         'pelvis.',
                         ...
                         'The osteological structure completing the ball-and-socket joint on the '
                         'right side of the body.')}


DATASET_CLASS_NAMES: Mapping[str, tuple[str, ...]] = MappingProxyType(
    _DATASET_CLASS_NAMES_RAW
)
TERM_DESCRIPTIONS: Mapping[str, tuple[str, ...]] = MappingProxyType(
    _TERM_DESCRIPTIONS_RAW
)

# Compatibility aliases matching the names used by the original M3D code.
dataset_info = DATASET_CLASS_NAMES
term_dict = TERM_DESCRIPTIONS


def normalise_dataset_tag(value: str | int) -> str:
    """Return a four-digit dataset tag without silently changing its value."""

    if isinstance(value, bool):
        raise AnatomyCatalogError("dataset tag cannot be boolean")
    if isinstance(value, int):
        if value < 0:
            raise AnatomyCatalogError("dataset tag cannot be negative")
        tag = f"{value:04d}"
    else:
        tag = str(value).strip()
        if tag.isdigit() and len(tag) < 4:
            tag = tag.zfill(4)
    if tag not in DATASET_CLASS_NAMES:
        allowed = f"{min(DATASET_CLASS_NAMES)}..{max(DATASET_CLASS_NAMES)}"
        raise AnatomyCatalogError(
            f"Unknown M3D dataset tag {value!r}; known range is {allowed}."
        )
    return tag


def class_names_for_dataset(dataset_tag: str | int) -> tuple[str, ...]:
    """Return the original ordered class list for one segmentation dataset."""

    return DATASET_CLASS_NAMES[normalise_dataset_tag(dataset_tag)]


def resolve_class_name(dataset_tag: str | int, class_id: int) -> str:
    """Resolve the zero-based label-file class ID exactly as original M3D."""

    if isinstance(class_id, bool) or not isinstance(class_id, int):
        raise AnatomyCatalogError(
            f"class_id must be an integer, got {type(class_id).__name__}"
        )
    names = class_names_for_dataset(dataset_tag)
    if class_id < 0 or class_id >= len(names):
        raise AnatomyCatalogError(
            f"class_id {class_id} is outside [0, {len(names) - 1}] for "
            f"dataset {normalise_dataset_tag(dataset_tag)!r}."
        )
    return names[class_id]


def descriptions_for(class_name: str) -> tuple[str, ...]:
    """Return all original natural-language descriptions for one class."""

    clean_name = str(class_name).strip()
    if not clean_name:
        raise AnatomyCatalogError("class_name cannot be empty")
    try:
        descriptions = TERM_DESCRIPTIONS[clean_name]
    except KeyError as exc:
        raise AnatomyCatalogError(
            f"No original M3D term descriptions exist for {clean_name!r}."
        ) from exc
    if not descriptions:
        raise AnatomyCatalogError(
            f"Description collection for {clean_name!r} is unexpectedly empty."
        )
    return descriptions


def catalogue_fingerprint() -> str:
    """Return a stable SHA-256 fingerprint saved with dataset checkpoints."""

    payload = {
        "dataset_info": {
            tag: list(names) for tag, names in DATASET_CLASS_NAMES.items()
        },
        "term_dict": {
            name: list(values) for name, values in TERM_DESCRIPTIONS.items()
        },
    }
    encoded = json.dumps(
        payload,
...
def validate_catalogue() -> None:
    """Validate coverage while preserving intentional duplicates and spelling."""

    if not DATASET_CLASS_NAMES:
        raise AnatomyCatalogError("DATASET_CLASS_NAMES cannot be empty")
    if not TERM_DESCRIPTIONS:
        raise AnatomyCatalogError("TERM_DESCRIPTIONS cannot be empty")

    referenced_names: set[str] = set()
    for tag, names in DATASET_CLASS_NAMES.items():
        if len(tag) != 4 or not tag.isdigit():
            raise AnatomyCatalogError(f"Invalid dataset tag {tag!r}")
        if not names:
            raise AnatomyCatalogError(f"Dataset {tag!r} has no class names")
        for index, name in enumerate(names):
            if not isinstance(name, str) or not name.strip():
                raise AnatomyCatalogError(
                    f"Dataset {tag!r} class {index} must be non-empty text"
                )
            referenced_names.add(name)

    missing = sorted(referenced_names.difference(TERM_DESCRIPTIONS))
    if missing:
        preview = ", ".join(repr(value) for value in missing[:10])
        raise AnatomyCatalogError(
            f"{len(missing)} class names have no descriptions: {preview}"
        )

    for name, descriptions in TERM_DESCRIPTIONS.items():
        if not isinstance(name, str) or not name.strip():
            raise AnatomyCatalogError("Description key cannot be empty")
        if not descriptions:
            raise AnatomyCatalogError(f"{name!r} has no descriptions")
        for index, description in enumerate(descriptions):
            if not isinstance(description, str) or not description.strip():
                raise AnatomyCatalogError(
                    f"{name!r} description {index} must be non-empty text"
                )
